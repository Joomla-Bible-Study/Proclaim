...
class biblestudyImportViewmp3 extends JView {

	function display($tpl = null) {
		$document =& JFactory::getDocument(); 
		$document->addStyleSheet(JURI::base().'components/com_biblestudyimport/assets/css/ui.css');
		$document->addStyleSheet(JURI::base().'components/com_biblestudyimport/assets/css/bsmImport.css');
		$document->addScript('http://ajax.googleapis.com/ajax/libs/jquery/1.4.2/jquery.min.js');
		$document->addScript('http://ajax.googleapis.com/ajax/libs/jqueryui/1.8.1/jquery-ui.min.js');
		$document->addScript(JURI::base().'components/com_biblestudyimport/assets/js/bsmImport.js');
