...
DROP TABLE IF EXISTS `#__bsms_admin`, `#__bsms_books`, `#__bsms_comments`, `#__bsms_folders`, `#__bsms_locations`, `#__bsms_media`, `#__bsms_mediafiles`, `#__bsms_message_type`, `#__bsms_mimetype`, `#__bsms_order`, `#__bsms_podcast`, `#__bsms_search`, `#__bsms_series`, `#__bsms_servers`, `#__bsms_share`, `#__bsms_studies`, `#__bsms_studytopics`, `#__bsms_teachers`, `#__bsms_templates`, `#__bsms_timeset`, `#__bsms_topics`, `#__bsms_update`, `#__bsms_version`;
...
(1, '', '', 'Billy Sunday', 'billy-sunday', 'Pastor', '555-555-5555', 'billy@sunday.com', 'http://billysunday.com', 'William Ashley Sunday was an American athlete who after being a popular outfielder in baseballs National League during the 1880s became the most celebrated and influential American evangelist during the first two decades of the 20th century. ', 'components/com_biblestudy/images/billy_sunday11.jpg', '276', '197', 'components/com_biblestudy/images/images.jpg', '101', '141', 'Billy Sunday: 1862-1935', 0, 1, 1, 1, 0, 1);
