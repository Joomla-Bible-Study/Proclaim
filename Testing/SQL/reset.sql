DROP TABLE IF EXISTS niy31_bsms_studies;
DROP TABLE IF EXISTS niy31_bsms_teachers;
DROP TABLE IF EXISTS niy31_bsms_topics;
DROP TABLE IF EXISTS niy31_bsms_servers;
DROP TABLE IF EXISTS niy31_bsms_series;
DROP TABLE IF EXISTS niy31_bsms_message_type;
DROP TABLE IF EXISTS niy31_bsms_folders;
DROP TABLE IF EXISTS niy31_bsms_order;
DROP TABLE IF EXISTS niy31_bsms_search;
DROP TABLE IF EXISTS niy31_bsms_schemaversion;
DROP TABLE IF EXISTS niy31_bsms_media;
DROP TABLE IF EXISTS niy31_bsms_books;
DROP TABLE IF EXISTS niy31_bsms_podcast;
DROP TABLE IF EXISTS niy31_bsms_mimetype;
DROP TABLE IF EXISTS niy31_bsms_mediafiles;
DROP TABLE IF EXISTS niy31_bsms_templates;
DROP TABLE IF EXISTS niy31_bsms_templatecode;
DROP TABLE IF EXISTS niy31_bsms_comments;
DROP TABLE IF EXISTS niy31_bsms_admin;
DROP TABLE IF EXISTS niy31_bsms_studytopics;
DROP TABLE IF EXISTS niy31_bsms_version;
DROP TABLE IF EXISTS niy31_bsms_share;
DROP TABLE IF EXISTS niy31_bsms_locations;
DROP TABLE IF EXISTS niy31_bsms_timeset;
DROP TABLE IF EXISTS niy31_bsms_styles;
DROP TABLE IF EXISTS niy31_bsms_install;
DROP TABLE IF EXISTS niy31_bsms_update;
DROP TABLE IF EXISTS `niy31_bsms_install`;

DROP TABLE IF EXISTS `niy31_bsms_update`;

CREATE TABLE IF NOT EXISTS `niy31_bsms_update` (
  id INT(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  version VARCHAR(255) DEFAULT NULL,
  PRIMARY KEY (id)
) DEFAULT CHARSET=utf8;

INSERT INTO `niy31_bsms_update` (id,version) VALUES
(1,'7.0.0'),
(2,'7.0.1'),
(3,'7.0.1.1'),
(4,'7.0.2'),
...
--
-- Table structure for table `niy31_bsms_admin`
--

CREATE TABLE IF NOT EXISTS `niy31_bsms_admin` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `drop_tables` int(3) DEFAULT '0',
  `params` text,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the niy31_assets table.',
...
--
-- Table structure for table `niy31_bsms_books`
--

CREATE TABLE IF NOT EXISTS `niy31_bsms_books` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `niy31_bsms_comments`
--

CREATE TABLE IF NOT EXISTS `niy31_bsms_comments` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `published` tinyint(3) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `niy31_bsms_folders`
--

CREATE TABLE IF NOT EXISTS `niy31_bsms_folders` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `niy31_bsms_locations`
--

CREATE TABLE IF NOT EXISTS `niy31_bsms_locations` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `niy31_bsms_media`
--

CREATE TABLE IF NOT EXISTS `niy31_bsms_media` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `media_text` text,
...
--
-- Table structure for table `niy31_bsms_mediafiles`
--

CREATE TABLE IF NOT EXISTS `niy31_bsms_mediafiles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `niy31_bsms_message_type`
--

CREATE TABLE IF NOT EXISTS `niy31_bsms_message_type` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `niy31_bsms_mimetype`
--

CREATE TABLE IF NOT EXISTS `niy31_bsms_mimetype` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `niy31_bsms_order`
--

CREATE TABLE IF NOT EXISTS `niy31_bsms_order` (
...
--
-- Table structure for table `niy31_bsms_podcast`
--

CREATE TABLE IF NOT EXISTS `niy31_bsms_podcast` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `niy31_bsms_search`
--

CREATE TABLE IF NOT EXISTS `niy31_bsms_search` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `value` varchar(15) DEFAULT '',
...
--
-- Table structure for table `niy31_bsms_series`
--

CREATE TABLE IF NOT EXISTS `niy31_bsms_series` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `series_text` text,
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Table structure for table `niy31_bsms_servers`
--

CREATE TABLE IF NOT EXISTS `niy31_bsms_servers` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `niy31_bsms_share`
--

CREATE TABLE IF NOT EXISTS `niy31_bsms_share` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `niy31_bsms_studies`
--

CREATE TABLE IF NOT EXISTS `niy31_bsms_studies` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `niy31_bsms_studytopics`
--

CREATE TABLE IF NOT EXISTS `niy31_bsms_studytopics` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `niy31_bsms_styles`
--

CREATE TABLE IF NOT EXISTS `niy31_bsms_styles` (
...
--
-- Table structure for table `niy31_bsms_teachers`
--

CREATE TABLE IF NOT EXISTS `niy31_bsms_teachers` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `teacher_image` text,
...
--
-- Table structure for table `niy31_bsms_templatecode`
--

CREATE TABLE IF NOT EXISTS `niy31_bsms_templatecode` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `published` tinyint(3) NOT NULL DEFAULT '1',
  `type` tinyint(3) NOT NULL,
  `filename` text NOT NULL,
...
--
-- Table structure for table `niy31_bsms_templates`
--

CREATE TABLE IF NOT EXISTS `niy31_bsms_templates` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `niy31_bsms_timeset`
--

CREATE TABLE IF NOT EXISTS `niy31_bsms_timeset` (
...
--
-- Table structure for table `niy31_bsms_topics`
--

CREATE TABLE IF NOT EXISTS `niy31_bsms_topics` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `topic_text` text,
  `published` tinyint(3) NOT NULL DEFAULT '1',
...
--
-- Dumping data for table `niy31_bsms_admin`
--

INSERT INTO `niy31_bsms_admin` (`id`, `drop_tables`, `params`, `asset_id`, `access`, `installstate`, `debug`) VALUES
...
--
-- Dumping data for table `niy31_bsms_books`
--

INSERT INTO `niy31_bsms_books` (`id`, `bookname`, `booknumber`, `published`) VALUES
...
--
-- Dumping data for table `niy31_bsms_folders`
--

INSERT INTO `niy31_bsms_folders` (`id`, `foldername`, `folderpath`, `published`, `asset_id`, `access`) VALUES
(1, 'My Folder Name', '/media/', 1, 0, 1);

--
-- Dumping data for table `niy31_bsms_locations`
--

INSERT INTO `niy31_bsms_locations` (`id`, `location_text`, `published`, `asset_id`, `access`, `ordering`) VALUES
(1, 'My Location', 1, 0, 1, 1);

--
-- Dumping data for table `niy31_bsms_media`
--

INSERT INTO `niy31_bsms_media` (`id`, `media_text`, `media_image_name`, `media_image_path`, `path2`, `media_alttext`, `published`, `asset_id`, `access`, `ordering`) VALUES
...
--
-- Dumping data for table `niy31_bsms_mediafiles`
--

INSERT INTO `niy31_bsms_mediafiles` (`id`, `study_id`, `media_image`, `server`, `path`, `special`, `filename`, `size`, `mime_type`, `podcast_id`, `internal_viewer`, `mediacode`, `ordering`, `createdate`, `link_type`, `hits`, `published`, `docMan_id`, `article_id`, `comment`, `virtueMart_id`, `downloads`, `plays`, `params`, `player`, `popup`, `asset_id`, `access`, `language`) VALUES
...
--
-- Dumping data for table `niy31_bsms_message_type`
--

INSERT INTO `niy31_bsms_message_type` (`id`, `message_type`, `alias`, `published`, `asset_id`, `access`, `ordering`) VALUES
(1, 'Sunday', 'sunday', 1, 0, 1, 1);

--
-- Dumping data for table `niy31_bsms_mimetype`
--

INSERT INTO `niy31_bsms_mimetype` (`id`, `mimetype`, `mimetext`, `published`, `asset_id`, `access`, `ordering`) VALUES
...
--
-- Dumping data for table `niy31_bsms_order`
--

INSERT INTO `niy31_bsms_order` (`id`, `value`, `text`) VALUES
(1, 'ASC', 'JBS_CMN_ASCENDING'),
(2, 'DESC', 'JBS_CMN_DESCENDING');

--
-- Dumping data for table `niy31_bsms_podcast`
--

INSERT INTO `niy31_bsms_podcast` (`id`, `title`, `website`, `description`, `image`, `imageh`, `imagew`, `author`, `podcastimage`, `podcastsearch`, `filename`, `language`, `editor_name`, `editor_email`, `podcastlimit`, `published`, `episodetitle`, `custom`, `detailstemplateid`, `asset_id`, `access`) VALUES
...
--
-- Dumping data for table `niy31_bsms_series`
--

INSERT INTO `niy31_bsms_series` (`id`, `series_text`, `alias`, `teacher`, `description`, `series_thumbnail`, `published`, `asset_id`, `ordering`, `access`, `language`) VALUES
(1, 'Worship Series', 'worship-series', -1, '', '', 1, 0, 1, 1, '*');

--
-- Dumping data for table `niy31_bsms_servers`
--

INSERT INTO `niy31_bsms_servers` (`id`, `server_name`, `server_path`, `published`, `server_type`, `ftp_username`, `ftp_password`, `asset_id`, `access`, `type`, `ftphost`, `ftpuser`, `ftppassword`, `ftpport`, `aws_key`, `aws_secret`) VALUES
(1, 'Your Server Name', 'www.mywebsite.com', 1, 'local', '', '', 0, 1, 0, '', '', '', '', '', '');

--
-- Dumping data for table `niy31_bsms_share`
--

INSERT INTO `niy31_bsms_share` (`id`, `name`, `params`, `published`, `asset_id`, `access`, `ordering`) VALUES
...
--
-- Dumping data for table `niy31_bsms_styles`
--

INSERT INTO `niy31_bsms_styles` (`id`, `published`, `filename`, `stylecode`, `asset_id`) VALUES
...
--
-- Dumping data for table `niy31_bsms_teachers`
--

INSERT INTO `niy31_bsms_teachers` (`id`, `teacher_image`, `teacher_thumbnail`, `teachername`, `alias`, `title`, `phone`, `email`, `website`, `information`, `image`, `imageh`, `imagew`, `thumb`, `thumbw`, `thumbh`, `short`, `ordering`, `catid`, `list_show`, `published`, `asset_id`, `access`, `language`) VALUES
...
--
-- Dumping data for table `niy31_bsms_templates`
--

INSERT INTO `niy31_bsms_templates` (`id`, `type`, `tmpl`, `published`, `params`, `title`, `text`, `pdf`, `asset_id`, `access`) VALUES
...
--
-- Dumping data for table `niy31_bsms_timeset`
--

INSERT INTO `niy31_bsms_timeset` (`timeset`, `backup`) VALUES
('1281646339', '1281646339');

--
-- Dumping data for table `niy31_bsms_topics`
--

INSERT INTO `niy31_bsms_topics` (`id`, `topic_text`, `published`, `params`, `asset_id`, `access`) VALUES
