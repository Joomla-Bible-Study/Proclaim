...
<div class="fbwelcome">
	...
	<?php echo 'Joomla Bible Study'?></h3>
	<p>

	<?php echo 'From here you can access all of the different views and tasks for creating and maintaining your sermons, messages, and studies. You can also find statistics about your studies located in one convenient place.';?></p>
</div>
		...
		<tr class="thisform">
			<td width="100%" valign="top" class="thisform"><div id="cpanel">
					<div style="float: left;">
						<div class="icon">
							<a
								href="index2.php?option=com_biblestudy&amp;view=admin&amp;layout=form"
								style="text-decoration: none;"
								title="<?php echo JText::_('Administration');?>"> <img
								src="components/com_biblestudy/images/openbible.gif"
								align="middle" border="0" /> <span> <?php echo JText::_('Administration'); ?>
							</span> </a>
						</div>
					</div>
					<div style="float: left;">
						<div class="icon">
							<a href="index2.php?option=com_biblestudy&amp;view=studieslist"
								style="text-decoration: none;"
								title="<?php echo JText::_('Studies/Sermons');?>"> <img
								src="components/com_biblestudy/images/openbible.gif"
								align="middle" border="0" /> <span> <?php echo JText::_('Studies/Sermons'); ?>
							</span> </a>
						</div>
					</div>
					<div style="float: left;">
						<div class="icon">
							<a
								href="index2.php?option=com_biblestudy&amp;view=mediafileslist"
								style="text-decoration: none;"
								title="<?php echo JText::_('Media Files');?>"> <img
								src="components/com_biblestudy/images/openbible.gif"
								align="middle" border="0" /> <span> <?php echo JText::_('Media Files'); ?>
							</span> </a>
						</div>
					</div>
					<div style="float: left;">
						<div class="icon">
							<a href="index2.php?option=com_biblestudy&amp;view=templateslist"
								style="text-decoration: none;"
								title="<?php echo JText::_('Template Display Settings');?>"> <img
								src="components/com_biblestudy/images/openbible.gif"
								align="middle" border="0" /> <span> <?php echo JText::_('Template Display Settings'); ?>
							</span> </a>
						</div>
					</div>
					<div style="float: left;">
						<div class="icon">
							<a href="index2.php?option=com_biblestudy&amp;view=cssedit"
								style="text-decoration: none;"
								title="<?php echo JText::_('Edit CSS');?>"> <img
								src="components/com_biblestudy/images/openbible.gif"
								align="middle" border="0" /> <span> <?php echo JText::_('Edit CSS'); ?>
							</span> </a>
						</div>
					</div>
					<div style="float: left;">
						<div class="icon">
							<a href="index2.php?option=com_biblestudy&amp;view=podcastlist"
								style="text-decoration: none;"
								title="<?php echo JText::_('Podcasts');?>"> <img
								src="components/com_biblestudy/images/openbible.gif"
								align="middle" border="0" /> <span> <?php echo JText::_('Podcasts'); ?>
							</span> </a>
						</div>
					</div>
					<div style="float: left;">
						<div class="icon">
							<a href="index2.php?option=com_biblestudy&amp;view=serieslist"
								style="text-decoration: none;"
								title="<?php echo JText::_('Series');?>"> <img
								src="components/com_biblestudy/images/openbible.gif"
								align="middle" border="0" /> <span> <?php echo JText::_('Series'); ?>
					...
					<div style="float: left;">
						<div class="icon">
							<a href="index2.php?option=com_biblestudy&amp;view=teacherlist"
								style="text-decoration: none;"
								title="<?php echo JText::_('Teachers');?>"> <img
								src="components/com_biblestudy/images/openbible.gif"
								align="middle" border="0" /> <span> <?php echo JText::_('Teachers');?>
					...
					<div style="float: left;">
						<div class="icon">
							<a href="index2.php?option=com_biblestudy&amp;view=bookslist"
								target="_blank" style="text-decoration: none;"
								title="<?php echoJText::_('Bible Books');?>"> <img
								src="components/com_biblestudy/images/openbible.gif"
								align="middle" border="0" /> <span> <?php echoJText::_('Bible Books'); ?>
							</span> </a>
						</div>
					</div>
					<div style="float: left;">
						<div class="icon">
							<a href="index2.php?option=com_biblestudy&amp;view=medialist"
								style="text-decoration: none;"
								title="<?php echo JText::_('Media Images');?>"> <img
								src="components/com_biblestudy/images/openbible.gif"
								align="middle" border="0" /> <span> <?php echo JText::_('Media Images');?>
					...
					<div style="float: left;">
						<div class="icon">
							<a href="index3.php?option=com_biblestudy&amp;view=serverslist"
								style="text-decoration: none;"
								title="<?php echo JText::_('Servers');?>"> <img
								src="components/com_biblestudy/images/openbible.gif"
								align="middle" border="0" /> <span> <?php echo JText::_('Servers'); ?>
					...
					<div style="float: left;">
						<div class="icon">
							<a href="index2.php?option=com_biblestudy&amp;view=folderslist"
								style="text-decoration: none;"
								title="<?php echo JText::_('Server Folders');?>"> <img
								src="components/com_biblestudy/images/openbible.gif"
								align="middle" border="0" /> <span> <?php echo JText::_('Server Folders'); ?>
					...
					<div style="float: left;">
						<div class="icon">
							<a
								href="index2.php?option=com_biblestudy&amp;view=messagetypelist"
								style="text-decoration: none;"
								title="<?php echo JText::_('Message Types');?>"> <img
								src="components/com_biblestudy/images/openbible.gif"
								align="middle" border="0" /> <span> <?php echo JText::_('Message Types'); ?>
							
							</a>
						</div>
					</div>
					<div class="icon">
						<a href="index2.php?option=com_biblestudy&amp;view=locationslist"
							style="text-decoration: none;"
							title="<?php echo JText::_('Locations');?>"> <img
							src="components/com_biblestudy/images/openbible.gif"
							align="middle" border="0" /> <span> <?php echo JText::_('Locations'); ?>
						
						</a>
					</div>
				</div>
				<div class="icon">
					<a href="index2.php?option=com_biblestudy&amp;view=topicslist"
						style="text-decoration: none;"
						title="<?php echo JText::_('Topics');?>"> <img
						src="components/com_biblestudy/images/openbible.gif"
						align="middle" border="0" /> <span> <?php echo JText::_('Topics'); ?>
					
					</a>
				</div>
				</div>
				<div class="icon">
					<a href="index2.php?option=com_biblestudy&amp;view=mimetypelist"
						style="text-decoration: none;"
						title="<?php echo JText::_('Mime Types');?>"> <img
						src="components/com_biblestudy/images/openbible.gif"
						align="middle" border="0" /> <span> <?php echo JText::_('Mime Types'); ?>
					
					</a>
				</div>
				</div>
				<div class="icon">
					<a href="index2.php?option=com_biblestudy&amp;view=commentslist"
						style="text-decoration: none;"
						title="<?php echo JText::_('Comments');?>"> <img
						src="components/com_biblestudy/images/openbible.gif"
						align="middle" border="0" /> <span> <?php echo JText::_('Comments'); ?>
					
					</a>
				</div>
				</div>
				<div class="icon">
					<a href="index2.php?option=com_biblestudy&amp;view=sharelist"
						style="text-decoration: none;"
						title="<?php echo JText::_('Social Networking Links');?>"> <img
						src="components/com_biblestudy/images/openbible.gif"
						align="middle" border="0" /> <span> <?php echo JText::_('Social Networking Links'); ?>
