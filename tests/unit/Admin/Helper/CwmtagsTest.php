...
/**
 * Test class for Cwmtags
 *
 * @since  10.0.0
 */
class CwmtagsTest extends ProclaimTestCase
{
    /**
    ...
    protected function setUp(): void
    {
        ...
        $this->classFile    = JPATH_ROOT . '/admin/src/Helper/Cwmtags.php';
    ...
    {
        $this->assertStringContainsString('class Cwmtags', $this->classContent);
    }
}
