...
/**
 * Unit tests for CwmImageCleanup
 *
...
/**
 * Test class for CwmImageCleanup
 *
 * @since  10.0.0
 */
class CwmImageCleanupTest extends ProclaimTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->classFile    = JPATH_ROOT . '/admin/src/Helper/CwmImageCleanup.php';
    ...
    {
        $this->assertStringContainsString('class CwmImageCleanup', $this->classContent);
    }
}
