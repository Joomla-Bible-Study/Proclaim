...
/**
 * Unit tests for Cwmsearchfilters
 *
...
/**
 * Test class for Cwmsearchfilters
 *
 * @since  10.0.0
 */
class CwmsearchfiltersTest extends ProclaimTestCase
{
    /**
    ...
    protected function setUp(): void
    {
        ...
        $this->classFile    = JPATH_ROOT . '/admin/src/Helper/Cwmsearchfilters.php';
    ...
    {
        $this->assertStringContainsString('class Cwmsearchfilters', $this->classContent);
    }
}
