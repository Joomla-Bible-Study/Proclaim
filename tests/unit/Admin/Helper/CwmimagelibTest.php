...
/**
 * Test class for Cwmimagelib
 *
 * @since  10.0.0
 */
class CwmimagelibTest extends ProclaimTestCase
{
    /**
    ...
    protected function setUp(): void
    {
        ...
        $this->classFile    = JPATH_ROOT . '/admin/src/Helper/Cwmimagelib.php';
    ...
    {
        $this->assertStringContainsString('class Cwmimagelib', $this->classContent);
    }
}
