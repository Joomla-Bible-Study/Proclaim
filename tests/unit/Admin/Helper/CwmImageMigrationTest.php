...
/**
 * Unit tests for CwmImageMigration
 *
...
/**
 * Test class for CwmImageMigration
 *
 * @since  10.0.0
 */
class CwmImageMigrationTest extends ProclaimTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->classFile    = JPATH_ROOT . '/admin/src/Helper/CwmImageMigration.php';
    ...
    {
        $this->assertStringContainsString('class CwmImageMigration', $this->classContent);
    }
}
