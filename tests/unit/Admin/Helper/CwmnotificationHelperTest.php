...
/**
 * Unit tests for CwmnotificationHelper
 *
...
/**
 * Test class for CwmnotificationHelper
 *
 * @since  10.0.0
 */
class CwmnotificationHelperTest extends ProclaimTestCase
{
    /**
    ...
    protected function setUp(): void
    {
        ...
        $this->classFile    = JPATH_ROOT . '/admin/src/Helper/CwmnotificationHelper.php';
    ...
    {
        $this->assertStringContainsString('class CwmnotificationHelper', $this->classContent);
    }
}
