...
/**
 * Unit tests for Cwmuploadscript
 *
...
/**
 * Test class for Cwmuploadscript
 *
 * @since  10.0.0
 */
class CwmuploadscriptTest extends ProclaimTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->classFile    = JPATH_ROOT . '/admin/src/Helper/Cwmuploadscript.php';
    ...
    {
        $this->assertStringContainsString('class Cwmuploadscript', $this->classContent);
    }
}
