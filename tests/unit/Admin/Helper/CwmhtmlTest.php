...
/**
 * Test class for Cwmhtml
 *
 * @since  10.0.0
 */
class CwmhtmlTest extends ProclaimTestCase
{
    /**
    ...
    protected function setUp(): void
    {
        ...
        $this->classFile    = JPATH_ROOT . '/admin/src/Helper/Cwmhtml.php';
    ...
    {
        $this->assertStringContainsString('class Cwmhtml', $this->classContent);
    }
}
