...
/**
 * Unit tests for CwmyoutubeHelper
 *
...
/**
 * Test class for CwmyoutubeHelper
 *
 * @since  10.0.0
 */
class CwmyoutubeHelperTest extends ProclaimTestCase
{
    /**
    ...
    protected function setUp(): void
    {
        ...
        $this->classFile    = JPATH_ROOT . '/admin/src/Helper/CwmyoutubeHelper.php';
    ...
    {
        $this->assertStringContainsString('class CwmyoutubeHelper', $this->classContent);
    }
}
