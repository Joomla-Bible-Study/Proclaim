...
/**
 * Test class for Cwmtranslated
 *
 * @since  10.0.0
 */
class CwmtranslatedTest extends ProclaimTestCase
{
    /**
    ...
    protected function setUp(): void
    {
        ...
        $this->classFile    = JPATH_ROOT . '/admin/src/Helper/Cwmtranslated.php';
    ...
    {
        $this->assertStringContainsString('class Cwmtranslated', $this->classContent);
    }
}
