...
/**
 * Unit tests for ServerListField
 *
...
/**
 * Test class for ServerListField
 *
 * #[CoversClass(ServerListField::class)]
 * @since  10.0.0
 */
class ServerListFieldTest extends ProclaimTestCase
{
     ...
     *
     * @return void
     * #[CoversClass(ServerListField::class)]::getOptions
     */
    public function testGetOptionsMethodSignature(): void
    {
        $reflection = new \ReflectionMethod(ServerListField::class, 'getOptions');
