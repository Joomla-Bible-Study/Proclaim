...
/**
 * Test class for SpanOptionsField
 *
 * #[CoversClass(SpanOptionsField::class)]
 * @since  10.0.0
 */
class SpanOptionsFieldTest extends ProclaimTestCase
{
     ...
     *
     * @return void
     * #[CoversClass(SpanOptionsField::class)]::getOptions
     */
    public function testGetOptionsMethodSignature(): void
    {
        $reflection = new \ReflectionMethod(SpanOptionsField::class, 'getOptions');
