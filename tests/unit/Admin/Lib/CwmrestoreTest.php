...
class CwmrestoreTest extends ProclaimTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->classFile    = JPATH_ROOT . '/admin/src/Lib/Cwmrestore.php';
    ...
    {
        $this->assertStringContainsString('class Cwmrestore', $this->classContent);
    }
}
