...
class CwmssconvertTest extends ProclaimTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->classFile    = JPATH_ROOT . '/admin/src/Lib/Cwmssconvert.php';
    ...
    {
        $this->assertStringContainsString('class Cwmssconvert', $this->classContent);
    }
}
