...
/**
 * Test class for CwmadminTable
 *
 * #[CoversClass(CwmadminTable::class)]
 * @since  10.0.0
 */
class CwmadminTableTest extends ProclaimTestCase
{
    /**
     * Test constructor
     *
     * @return void
     * #[CoversClass(CwmadminTable::class)]::__construct
     */
    public function testConstructor(): void
    {
        $db = $this->createMock(DatabaseDriver::class);
        $table = new CwmadminTable($db);
        $this->assertInstanceOf(CwmadminTable::class, $table);
    }
     ...
     *
     * @return void
     * #[CoversClass(CwmadminTable::class)]::bind
     */
    public function testBindMethodSignature(): void
    {
        $reflection = new \ReflectionMethod(CwmadminTable::class, 'bind');
     ...
     *
     * @return void
     * #[CoversClass(CwmadminTable::class)]::store
     */
    public function testStoreMethodSignature(): void
    {
        $reflection = new \ReflectionMethod(CwmadminTable::class, 'store');
     ...
     *
     * @return void
     * #[CoversClass(CwmadminTable::class)]::_getAssetName
     */
    public function testGetAssetNameMethodSignature(): void
    {
        $reflection = new \ReflectionMethod(CwmadminTable::class, '_getAssetName');
     ...
     *
     * @return void
     * #[CoversClass(CwmadminTable::class)]::_getAssetTitle
     */
    public function testGetAssetTitleMethodSignature(): void
    {
        $reflection = new \ReflectionMethod(CwmadminTable::class, '_getAssetTitle');
     ...
     *
     * @return void
     * #[CoversClass(CwmadminTable::class)]::_getAssetParentId
     */
    public function testGetAssetParentIdMethodSignature(): void
    {
        $reflection = new \ReflectionMethod(CwmadminTable::class, '_getAssetParentId');
