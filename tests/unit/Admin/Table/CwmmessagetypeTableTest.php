...
/**
 * Unit tests for CwmmessagetypeTable
 *
...
/**
 * Test class for CwmmessagetypeTable
 *
 * #[CoversClass(CwmmessagetypeTable::class)]
 * @since  10.0.0
 */
class CwmmessagetypeTableTest extends ProclaimTestCase
{
    /**
     * Test constructor
     *
     * @return void
     * #[CoversClass(CwmmessagetypeTable::class)]::__construct
     */
    public function testConstructor(): void
    {
        $db    = $this->createMock(DatabaseDriver::class);
        $table = new CwmmessagetypeTable($db);
        $this->assertInstanceOf(CwmmessagetypeTable::class, $table);
    }
     ...
     *
     * @return void
     * #[CoversClass(CwmmessagetypeTable::class)]::check
     */
    public function testCheckMethodSignature(): void
    {
        $reflection = new \ReflectionMethod(CwmmessagetypeTable::class, 'check');
     ...
     *
     * @return void
     * #[CoversClass(CwmmessagetypeTable::class)]::bind
     */
    public function testBindMethodSignature(): void
    {
        $reflection = new \ReflectionMethod(CwmmessagetypeTable::class, 'bind');
     ...
     *
     * @return void
     * #[CoversClass(CwmmessagetypeTable::class)]::store
     */
    public function testStoreMethodSignature(): void
    {
        $reflection = new \ReflectionMethod(CwmmessagetypeTable::class, 'store');
     ...
     *
     * @return void
     * #[CoversClass(CwmmessagetypeTable::class)]::load
     */
    public function testLoadMethodSignature(): void
    {
        $reflection = new \ReflectionMethod(CwmmessagetypeTable::class, 'load');
     ...
     *
     * @return void
     * #[CoversClass(CwmmessagetypeTable::class)]::_getAssetName
     */
    public function testGetAssetNameMethodSignature(): void
    {
        $reflection = new \ReflectionMethod(CwmmessagetypeTable::class, '_getAssetName');
     ...
     *
     * @return void
     * #[CoversClass(CwmmessagetypeTable::class)]::_getAssetTitle
     */
    public function testGetAssetTitleMethodSignature(): void
    {
        $reflection = new \ReflectionMethod(CwmmessagetypeTable::class, '_getAssetTitle');
     ...
     *
     * @return void
     * #[CoversClass(CwmmessagetypeTable::class)]::_getAssetParentId
     */
    public function testGetAssetParentIdMethodSignature(): void
    {
        $reflection = new \ReflectionMethod(CwmmessagetypeTable::class, '_getAssetParentId');
