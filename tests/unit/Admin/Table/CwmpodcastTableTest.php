...
/**
 * Unit tests for CwmpodcastTable
 *
...
/**
 * Test class for CwmpodcastTable
 *
 * #[CoversClass(CwmpodcastTable::class)]
 * @since  10.0.0
 */
class CwmpodcastTableTest extends ProclaimTestCase
{
    /**
     * Test constructor
     *
     * @return void
     * #[CoversClass(CwmpodcastTable::class)]::__construct
     */
    public function testConstructor(): void
    {
        $db = $this->createMock(DatabaseDriver::class);
        $table = new CwmpodcastTable($db);
        $this->assertInstanceOf(CwmpodcastTable::class, $table);
    }
     ...
     *
     * @return void
     * #[CoversClass(CwmpodcastTable::class)]::check
     */
    public function testCheckMethodSignature(): void
    {
        $reflection = new \ReflectionMethod(CwmpodcastTable::class, 'check');
     ...
     *
     * @return void
     * #[CoversClass(CwmpodcastTable::class)]::bind
     */
    public function testBindMethodSignature(): void
    {
        $reflection = new \ReflectionMethod(CwmpodcastTable::class, 'bind');
     ...
     *
     * @return void
     * #[CoversClass(CwmpodcastTable::class)]::store
     */
    public function testStoreMethodSignature(): void
    {
        $reflection = new \ReflectionMethod(CwmpodcastTable::class, 'store');
     ...
     *
     * @return void
     * #[CoversClass(CwmpodcastTable::class)]::_getAssetName
     */
    public function testGetAssetNameMethodSignature(): void
    {
        $reflection = new \ReflectionMethod(CwmpodcastTable::class, '_getAssetName');
     ...
     *
     * @return void
     * #[CoversClass(CwmpodcastTable::class)]::_getAssetTitle
     */
    public function testGetAssetTitleMethodSignature(): void
    {
        $reflection = new \ReflectionMethod(CwmpodcastTable::class, '_getAssetTitle');
     ...
     *
     * @return void
     * #[CoversClass(CwmpodcastTable::class)]::_getAssetParentId
     */
    public function testGetAssetParentIdMethodSignature(): void
    {
        $reflection = new \ReflectionMethod(CwmpodcastTable::class, '_getAssetParentId');
