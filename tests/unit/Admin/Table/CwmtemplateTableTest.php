...
/**
 * Unit tests for CwmtemplateTable
 *
...
/**
 * Test class for CwmtemplateTable
 *
 * #[CoversClass(CwmtemplateTable::class)]
 * @since  10.0.0
 */
class CwmtemplateTableTest extends ProclaimTestCase
{
    /**
     * Test constructor
     *
     * @return void
     * #[CoversClass(CwmtemplateTable::class)]::__construct
     */
    public function testConstructor(): void
    {
        $db = $this->createMock(DatabaseDriver::class);
        $table = new CwmtemplateTable($db);
        $this->assertInstanceOf(CwmtemplateTable::class, $table);
    }
     ...
     *
     * @return void
     * #[CoversClass(CwmtemplateTable::class)]::bind
     */
    public function testBindMethodSignature(): void
    {
        $reflection = new \ReflectionMethod(CwmtemplateTable::class, 'bind');
     ...
     *
     * @return void
     * #[CoversClass(CwmtemplateTable::class)]::store
     */
    public function testStoreMethodSignature(): void
    {
        $reflection = new \ReflectionMethod(CwmtemplateTable::class, 'store');
     ...
     *
     * @return void
     * #[CoversClass(CwmtemplateTable::class)]::delete
     */
    public function testDeleteMethodSignature(): void
    {
        $reflection = new \ReflectionMethod(CwmtemplateTable::class, 'delete');
     ...
     *
     * @return void
     * #[CoversClass(CwmtemplateTable::class)]::_getAssetName
     */
    public function testGetAssetNameMethodSignature(): void
    {
        $reflection = new \ReflectionMethod(CwmtemplateTable::class, '_getAssetName');
     ...
     *
     * @return void
     * #[CoversClass(CwmtemplateTable::class)]::_getAssetTitle
     */
    public function testGetAssetTitleMethodSignature(): void
    {
        $reflection = new \ReflectionMethod(CwmtemplateTable::class, '_getAssetTitle');
     ...
     *
     * @return void
     * #[CoversClass(CwmtemplateTable::class)]::_getAssetParentId
     */
    public function testGetAssetParentIdMethodSignature(): void
    {
        $reflection = new \ReflectionMethod(CwmtemplateTable::class, '_getAssetParentId');
