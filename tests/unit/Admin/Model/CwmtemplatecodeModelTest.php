...
/**
 * Unit tests for CwmtemplatecodeModel
 *
...
/**
 * Test class for CwmtemplatecodeModel
 *
 * #[CoversClass(CwmtemplatecodeModel::class)]
 * @since  10.0.0
 */
class CwmtemplatecodeModelTest extends ProclaimTestCase
{
    /**
     * Test getForm method signature
     *
     * @return void
     * #[CoversClass(CwmtemplatecodeModel::class)]::getForm
     */
    public function testGetFormMethodSignature(): void
    {
        $reflection = new \ReflectionMethod(CwmtemplatecodeModel::class, 'getForm');
     ...
     *
     * @return void
     * #[CoversClass(CwmtemplatecodeModel::class)]::getType
     */
    public function testGetTypeMethodSignature(): void
    {
        $reflection = new \ReflectionMethod(CwmtemplatecodeModel::class, 'getType');
     ...
     *
     * @return void
     * #[CoversClass(CwmtemplatecodeModel::class)]::getItem
     */
    public function testGetItemMethodSignature(): void
    {
        $reflection = new \ReflectionMethod(CwmtemplatecodeModel::class, 'getItem');
     ...
     *
     * @return void
     * #[CoversClass(CwmtemplatecodeModel::class)]::populateState
     */
    public function testPopulateStateMethodSignature(): void
    {
        $reflection = new \ReflectionMethod(CwmtemplatecodeModel::class, 'populateState');
     ...
     *
     * @return void
     * #[CoversClass(CwmtemplatecodeModel::class)]::getTable
     */
    public function testGetTableMethodSignature(): void
    {
        $reflection = new \ReflectionMethod(CwmtemplatecodeModel::class, 'getTable');
