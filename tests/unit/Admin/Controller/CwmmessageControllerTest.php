...
/**
 * Test class for CwmmessageController
 *
 * @since  10.0.0
 */
class CwmmessageControllerTest extends ProclaimTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->classFile    = JPATH_ROOT . '/admin/src/Controller/CwmmessageController.php';
    ...
    {
        $this->assertStringContainsString('class CwmmessageController', $this->classContent);
    }
}
