...
/**
 * Unit tests for CwmmessagesController
 *
...
/**
 * Test class for CwmmessagesController
 *
 * @since  10.0.0
 */
class CwmmessagesControllerTest extends ProclaimTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->classFile    = JPATH_ROOT . '/admin/src/Controller/CwmmessagesController.php';
    ...
    {
        $this->assertStringContainsString('class CwmmessagesController', $this->classContent);
    }

    /**
     * Test class has getModel method
     *
     * @return void
     */
    public function testClassHasGetModelMethod(): void
    {
        $this->assertStringContainsString('public function getModel($name = \'Cwmmessage\', $prefix = \'Administrator\', $config = [\'ignore_request\' => true])', $this->classContent);
    }
}
