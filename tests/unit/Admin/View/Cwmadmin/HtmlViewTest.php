...
/**
 * Unit tests for Cwmadmin HtmlView
 *
...
namespace CWM\Component\Proclaim\Tests\Admin\View\Cwmadmin;

use CWM\Component\Proclaim\Administrator\View\Cwmadmin\HtmlView;
use CWM\Component\Proclaim\Tests\ProclaimTestCase;
use PHPUnit\Framework\Attributes\CoversClass;

/**
 * Test class for Cwmadmin HtmlView
 *
...
class HtmlViewTest extends ProclaimTestCase
{
    ...
    /**
     * Test getComponentVersion method signature
     *
     * @return void
     * #[CoversClass(HtmlView::class)]::getComponentVersion
     */
    public function testGetComponentVersionMethodSignature(): void
    {
        $reflection = new \ReflectionMethod(HtmlView::class, 'getComponentVersion');
