...
/**
 * Unit tests for Cwmcomments HtmlView
 *
...
namespace CWM\Component\Proclaim\Tests\Admin\View\Cwmcomments;

use CWM\Component\Proclaim\Administrator\View\Cwmcomments\HtmlView;
use CWM\Component\Proclaim\Tests\ProclaimTestCase;
use PHPUnit\Framework\Attributes\CoversClass;

/**
 * Test class for Cwmcomments HtmlView
 *
...
class HtmlViewTest extends ProclaimTestCase
{
    ...
    /**
     * Test getPendingCount method signature
     *
     * @return void
     * #[CoversClass(HtmlView::class)]::getPendingCount
     */
    public function testGetPendingCountMethodSignature(): void
    {
        $reflection = new \ReflectionMethod(HtmlView::class, 'getPendingCount');
