...
require_once dirname(dirname(dirname(__FILE__))) . '/com_biblestudy/admin/lib/biblestudy.defines.php';
...
// Exclude all of the tests from code coverage reports
PHPUnit_Util_Filter::addDirectoryToFilter(JPATH_TESTS_JBS . '/tests');
