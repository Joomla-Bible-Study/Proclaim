...
--
-- Host: localhost
-- Generation Time: Feb 08, 2011 at 11:49 AM
...
INSERT INTO `#__bsms_admin` (`id`, `podcast`, `series`, `study`, `teacher`, `media`, `download`, `main`, `params`, `showhide`) VALUES
(1, '', '', '', '', 'speaker24.png', 'download.png', 'openbible.png', 'compat_mode=0\r\ndrop_tables=0\r\nadmin_store=1\r\nstudylistlimit=10\r\nseries_imagefolder=\r\nmedia_imagefolder=\r\nteachers_imagefolder=\r\nstudy_images=\r\npodcast_imagefolder=\r\nlocation_id=\r\nteacher_id=\r\nseries_id=\r\nbooknumber=\r\ntopic_id=\r\nmessagetype=\r\navr=0\r\ndownload=\r\ntarget=\r\nserver=\r\npath=\r\npodcast=0\r\nmime=0\r\nallow_entry_study=0\r\nentry_access=23\r\nstudy_publish=0', NULL);
...
INSERT INTO `#__bsms_mediafiles` (`id`, `study_id`, `media_image`, `server`, `path`, `special`, `filename`, `size`, `mime_type`, `podcast_id`, `internal_viewer`, `mediacode`, `ordering`, `createdate`, `link_type`, `hits`, `published`, `docMan_id`, `article_id`, `comment`, `virtueMart_id`, `params`, `downloads`, `plays`) VALUES
(1, 1, 2, '1', '1', '', '2011-001.mp3', '23445', 0, 0, 0, '', 0, '2011-02-01 00:00:00', NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, 0, 0);
...
(1, '6.1.0', '2009-11-30', '2011-02-08', '613', 'Numbers'),
(2, '6.2.0', '2010-09-06', '2011-02-08', '614', 'Deuteronomy'),
(3, '6.2.1', '2010-09-27', '2011-02-08', '615', 'Joshua'),
(4, '6.2.2', '2010-10-25', '2011-02-08', '622', 'Judges'),
(5, '6.2.3', '2010-11-03', '2011-02-08', '623', '1Samuel'),
(6, '6.2.4', '2010-11-09', '2011-02-08', '624', '2Samuel');
