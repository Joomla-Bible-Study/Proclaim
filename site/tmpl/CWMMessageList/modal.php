...
?>
<form
	action="<?php echo Route::_('index.php?option=com_proclaim&view=messagelist&layout=modal&tmpl=component&function=' . $function); ?>"
	...
	<table class="table table-striped table-condensed">
		...
		foreach ($this->items as $i => $item) :
			...
			<tr class="row<?php echo $i % 2; ?>">
				...
				<td class="center">
					<?php echo HtmlHelper::_('jgrid.published', $item->published, $i, 'studieslist.', true, 'cb', '', ''); ?>
				</td>
				<td class="center">
					<?php echo Text::sprintf($item->bookname) . ' ' . $this->escape($item->chapter_begin) . ':' . $this->escape($item->verse_begin); ?>
				</td>
				<td class="center">
