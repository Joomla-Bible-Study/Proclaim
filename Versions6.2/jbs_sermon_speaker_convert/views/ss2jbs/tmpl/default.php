...
<form action="index.php" method="post" name="adminForm" id="adminForm">
	<div class="col100">
		<fieldset class="adminform">
			...
			<?php echo JText::_('Conversion Form'); ?></legend>
			<table class="admintable">
				<tr>
					<td class="key"><label for="version"><?php echo JText::_('Version check');?>
					</label>
					</td>
				...
				<tr>
					<td width="100" align="right" class="key"><label for="conversion"> <?php echo JText::_('Perform the Conversion'); ?>
					</label>
					</td>
					<td>
	...
	<input type="hidden" name="option" value="com_ss2jbs" /> <input
