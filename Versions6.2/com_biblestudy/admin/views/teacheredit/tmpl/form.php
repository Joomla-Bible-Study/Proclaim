...
<form action="index.php" method="post" name="adminForm" id="adminForm" title="adminForm">
<div class="col100">
	<fieldset class="adminform">
		<legend><?php echo JText::_( 'Details' ); ?></legend>

		<table class="admintable" summary="admintable">
        <tr>
    ...
    <td> <?php  ?>
    <img <?php if(empty($this->teacheredit->teacher_image)){echo ('style="display: none;"');}?> id="imgteacher_image" src="<?php echo '../images/'.$this->admin_params->get('teachers_imagefolder', 'stories').'/'.$this->teacheredit->teacher_image;?>" alt="" name="teacherImage">
    <?php
	?>
    </td>
    ...
    <td> <?php  ?>
    <img <?php if(empty($this->teacheredit->teacher_thumbnail)){echo ('style="display: none;"');}?> id="imgteacher_thumbnail" src="<?php echo '../images/'.$this->admin_params->get('teachers_imagefolder', 'stories').'/'.$this->teacheredit->teacher_thumbnail;?>" alt="" name="teacherThumb">
    <?php
	?>
    </td>
