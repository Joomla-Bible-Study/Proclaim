...
';
  ...
  $episodedetailtemp = '	<item>
		<title>'.$title.'</title>
		<link>http://'.$podinfo->website.'/index.php?option=com_biblestudy&amp;view=studydetails&amp;id='.$episode->sid.$detailstemplateid.'</link>
		<comments>http://'.$podinfo->website.'/index.php?option=com_biblestudy&amp;view=studydetails&amp;id='.$episode->sid.$detailstemplateid.'</comments>
