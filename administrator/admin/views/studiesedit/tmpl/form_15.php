...
<?php if ($this->studiesedit->user_name == '') {
    $user_name = $user->name;
} else {
...
<?php echo JText::_('JBS_CMN_TOPIC'); ?>
                            ...
                            <tr>
                                ...
                                <td>
                        <?php
                                    //If Joomla 1.6 get the user group list from the view.html.php
                                    if (JOOMLA_VERSION == '6') {
                        ...
                        ?>
                                ...
                                <option value="0"
                                    <?php if ($show == '0') {
                                        ...
                                        } ?>><?php echo JText::_('JBS_CMN_EVERYONE'); ?></option>
                                <option value="18"
                                    <?php if ($show == '18') {
                                            echo 'selected="selected"';
                                        } ?>><?php echo JText::_('JBS_CMN_REGISTERED'); ?></option>
                                <option value="19"
                                    <?php if ($show == '19') {
                                            echo 'selected="selected"';
                                        } ?>><?php echo JText::_('JBS_CMN_AUTHORS'); ?></option>
                                <option value="20"
                                    <?php if ($show == '20') {
                                            echo 'selected="selected"';
                                        } ?>><?php echo JText::_('JBS_CMN_EDITORS'); ?></option>
                                            <option value="21"
                        <?php if ($show == '21') {
                                            echo 'selected="selected"';
                                        } ?>><?php echo JText::_('JBS_CMN_PUBLISHERS'); ?></option>
                                            <option value="23"
<?php if ($show == '23') {
                                            echo 'selected="selected"';
                                        } ?>><?php echo JText::_('JBS_CMN_MANAGERS'); ?></option>
                                        <option value="24"
<?php if ($show == '24') {
                                            echo 'selected="selected"';
                                        } ?>><?php echo JText::_('JBS_CMN_ADMIN_SUPERADMIN'); ?></option>
                                        </select>
<?php
...
<?php echo JText::_('JBS_STY_STUDY_IMAGE'); ?>
                                        ...
                                        <td> <?php ?>
                                            <img <?php if (empty($this->studiesedit->thumbnailm)) {
                                        echo ('style="display: none;"');
                                    } ?> id="imgthumbnailm" src="<?php echo '../images/' . $this->admin_params->get('study_images', 'stories') . '/' . $this->studiesedit->thumbnailm; ?>">
<?php ?>
                                        </td>
