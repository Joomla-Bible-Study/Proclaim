...
<?php    if ($this->studiesedit->user_name == ''){$user_name = $user->name;}else{$user_name = $this->studiesedit->user_name;}?>
    <tr>
     ...
     <td><input class="text_area" type="text" name="user_name" id="user_name" size="25" maxlength="25" value="<?php echo $user_name;?>" /></td>
    </tr>
    <tr> 
    ...
    <tr> 
     ...
     <td><?php 
      ...
      } ?><br /><span style="font-family:serif; color:gray;">(<?php echo JText::_( 'YYYY-MM-DD' ); ?>)</span>
     </td>
    </tr>
    <tr>
     <td class="key" align="left"><?php echo JText::_( 'Study Number' ); ?>:</td>
	 <td> <input class="text_area" type="text" name="studynumber" id="studynumber" size="25" maxlength="25" value="<?php echo $this->studiesedit->studynumber;?>" /></td>
    </tr>
	<tr>
     <td class="key" align="left"><?php echo JText::_( 'Title' ); ?>:</td>
     <td> <input class="text_area" type="text" name="studytitle" id="studytitle" size="100" maxlength="250" value="<?php echo $this->studiesedit->studytitle;?>" /></td>
    </tr>
    <tr> 
     <td class="key" align="left"><?php echo JText::_( 'Description' ); ?>:</td>
     <td> <textarea name="studyintro" cols="100" class="text_area" id="studyintro"><?php echo $this->studiesedit->studyintro;?></textarea></td>
    </tr>
    <tr> 
    ...
    <tr>
     ...
     <td><select name="show_level" id="show_level" class="inputbox" size="1">
       <?php 
    ...
    <tr>
     ...
     <td>
      <table>
	   ...
	   <tr>
	    <td><?php echo JText::_('Product ID for CD');?>:<input class="text_area" type="text" name="prod_cd" id="prod_cd" size="50" maxlength="50" value="<?php echo $this->studiesedit->prod_cd;?>"/></td>
	   </tr>
	   <tr>
	   ...
	   <tr>
	    <td><?php echo JText::_('Product ID for DVD');?>:<input class="text_area" type="text" name="prod_dvd" id="prod_dvd" size="50" maxlength="50" value="<?php echo $this->studiesedit->prod_dvd;?>"/></td>
	   </tr>
      </table>
     </td>
    </tr>
