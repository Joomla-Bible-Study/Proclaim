...
* @link http://www.JoomlaBibleStudy.com
*
...
class CBiblestudyVersion {
	...
	*/
	function version()
	{
		...
		return 'Biblestudy '.$version->version.' | '.$version->versiondate.' | '.$version->build.' [ '.$version->versionname.' ]';
	}
	...
	*/
	function versionHTML()
	{
		...
		return _BIBLESTUDY_INSTALLED_VERSION.': '.$version.' | '._BIBLESTUDY_COPYRIGHT.': &copy; 2007-2010 <a href = "http://www.JoomlaBibleStudy.com" target = "_blank">Joomla Bible Study</a>  | '._BIBLESTUDY_LICENSE.': <a href = "http://www.gnu.org/copyleft/gpl.html" target = "_blank">GNU GPL</a>';
	}
