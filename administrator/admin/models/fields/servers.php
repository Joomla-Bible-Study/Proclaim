...
class JFormFieldServers extends JFormField
{
	...
	{
		$db = JFactory::getDBO();
		$db->setQuery("SELECT id as value, server_name as text FROM #__bsms_servers WHERE published=1 ORDER BY server_name ASC");
		$html[] = JHTML::_('select.option', '0', '- '. JText::_('JBS_CMN_SELECT_SERVER') .' -' );
