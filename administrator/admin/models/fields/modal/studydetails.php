...
class JFormFieldModal_Studydetails extends JFormField
{
	...
	protected function getInput()
	{
		...
		$link = 'index.php?option=com_biblestudy&amp;view=studieslist&amp;layout=modal&amp;tmpl=component&amp;function=jSelectChart_'.$this->id;
		...
		$html .= '<div class="button2-left"><div class="blank"><a class="modal" title="'.JText::_('JBS_CHANGE_STUDY_BUTTON').'"  href="'.$link.'" rel="{handler: \'iframe\', size: {x: 800, y: 450}}">'.JText::_('JBS_CHANGE_STUDY_BUTTON').'</a></div></div>'."\n";
