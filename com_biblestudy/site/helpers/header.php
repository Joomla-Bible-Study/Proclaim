...
class JBSMHeader
{
	 ...
	 * @return string
	 */
	public static function getHeader($row, $params, $admin_params, $template, $showheader, $ismodule)
	{
		if (!$row)
		{
			return null;
	 ...
	 * @return string
	 */
	private static function getHeadercell(
		$rowid,
		$row,
		$params,
		$lastcol,
	 ...
	 * @return string
	 */
	private static function getCustomhead($rowcolid, $params)
	{
