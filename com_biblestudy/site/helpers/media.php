	...
	function getInternalPlayer($media, $params, $admin_params)
		{
            ...
            $media1_link =
			'<script language="JavaScript" src="'.JURI::base().'components/com_biblestudy/assets/player/jwplayer.js"></script>
		    <object type="application/x-shockwave-flash" data="'.JURI::base().'components/com_biblestudy/assets/player/player.swf" id="audioplayer'.$row_count.'" height="24" width="'.$params->get('player_width', 290).'">
		    <param name="movie" value="'.JURI::base().'components/com_biblestudy/assets/player/player.swf">
