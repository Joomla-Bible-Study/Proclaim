        ...
        foreach ($rows as $sharerow) {
            ...
            if ($share_params->get('item1')) {
                if ($share_params->get('item1') == 200) {
                    ...
                    $element1 = getElementid($share_params->get('item1'), $row, $params, $admin_params, $template = 1);
                }
            }
            if ($share_params->get('item2')) {
                if ($share_params->get('item2') == 200) {
                    ...
                    $element2 = getElementid($share_params->get('item2'), $row, $params, $admin_params, $template = 1);
                }
            }
            if ($share_params->get('item3')) {
                if ($share_params->get('item3') == 200) {
                    ...
                    $element3 = getElementid($share_params->get('item3'), $row, $params, $admin_params, $template = 1);
                }
            }
            if ($share_params->get('item4')) {
                if ($share_params->get('item4') == 200) {
                    ...
                    $element4 = getElementid($share_params->get('item4'), $row, $params, $admin_params, $template = 1);
                }
            }
