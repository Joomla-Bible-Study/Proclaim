...
<?php echo JText::_('JBS_CMN_MEDIA');?></h2>
<form
	...
	<fieldset id="filter-bar">
		<div class="filter-search fltlft">
			...
			<button type="button"
				onclick="document.id('filter_filename').value='';document.id('filter_studytitle').value='';this.form.submit();">

				<?php echo JText::_('JSEARCH_FILTER_CLEAR'); ?></button>
		</div>
		<div class="clr"></div>
		<div class="filter-select fltrt">
			<select name="filter_mediatypeId" class="inputbox"
				onchange="this.form.submit()">
				<option value="">
					
				<?php echo JText::_('JBS_MED_SELECT_MEDIA_TYPE'); ?></option>
	...
	<table class="adminlist">
		<thead>
			<tr>
				...
				<th width="5%">
				<?php
				echo JHtml::_('grid.sort', 'JBS_CMN_HEADING_ORDERING', 'mediafile.ordering', $listDirn, $listOrder);
