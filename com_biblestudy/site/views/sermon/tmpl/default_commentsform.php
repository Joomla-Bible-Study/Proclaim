                ...
                <table id="commentssubmittable" border="0">
                    ...
                    if ($allow >= 10) {
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="text_area" size="50" type="text" name="full_name" id="full_name" value="<?php echo $full_name ?>" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input class="text_area" type="text" size="50" name="user_email" id="user_email" value="<?php echo $user->email ?>" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <textarea class="text_area" cols="20" rows="4" style="width:400px" name="comment_text" id="comment_text">
                                </textarea>
                            </td>
                        </tr>
                        <tr>
