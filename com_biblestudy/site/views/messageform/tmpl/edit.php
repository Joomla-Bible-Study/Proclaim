    ...
    <table class="adminlist">
		...
		if (count($this->mediafiles) > 0) :
            ...
            <tr class="row<?php echo $i % 2; ?>">
                <td align="center">
					<?php $link = 'index.php?option=com_biblestudy&amp;task=mediafileform.edit&amp;id=' . (int)$item->id . '&amp;tmpl=component&amp;view=mediafileform&amp;layout=modal'; ?>
        ...
        <tr>
            <td colspan="4">
				<?php $link = 'index.php?option=com_biblestudy&amp;task=mediafileform.edit&amp;id=0&amp;sid=' . $this->form->getValue('id') . '&amp;tmpl=component&amp;view=mediafileform&amp;layout=modal'; ?>
				<?php
