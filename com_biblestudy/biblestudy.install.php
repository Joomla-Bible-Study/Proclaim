...
<legend><?php echo JText::_('Installation/Upgrade Results'); ?></legend>  
    
<?php echo JHtml::_('sliders.start','content-sliders-1',array('useCookie'=>1)); ?>
                                 
<?php echo JHtml::_('sliders.panel','Results', 'publishing-details'); ?>
<fieldset class="panelform">

 <?php echo $message;  ?>   

<?php echo JHtml::_('sliders.panel','CSS', 'publishing-details'); ?>                     
<fieldset class="panelform">
...
<?php
        ...
        function upgrade()
    {
        ...
        $include = JPATH_ADMINISTRATOR .DS. 'components' .DS. 'com_biblestudy' .DS. 'install' .DS. 'biblestudy.700.upgrade.php';
        $fileCheck = file_exists($include);
                ...
                $msg .= '<tr><td>';
                $msg .= '<div >'.$this->_error.'<pre>'.$include.'</pre></div></td><td width="20" valign="top"><img src="images/'.$img.'"></td></tr>';
