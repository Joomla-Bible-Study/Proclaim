...
class jbs700Install {
    ...
    function upgrade700() {
        ...
        $query = "ALTER Table `#__bsms_comments` MODIFY id int(3) AUTO_INCREMENT NOT NULL ";
        $msg = $this->performdb($query);
        if (!$msg) {
            $messages[] = '<font color="green">' . JText::_('JBS_IBM_QUERY_SUCCESS') . ': ' . $query . ' </font><br /><br />';
        } else {
        ...
        $query = "ALTER Table `#__bsms_folders` MODIFY id int(3) AUTO_INCREMENT NOT NULL";
        $msg = $this->performdb($query);
        if (!$msg) {
            $messages[] = '<font color="green">' . JText::_('JBS_IBM_QUERY_SUCCESS') . ': ' . $query . ' </font><br /><br />';
        } else {
        ...
        $query = "ALTER TABLE #__bsms_locations MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
                    ADD COLUMN asset_id INT(10) DEFAULT NULL, ADD COLUMN access INT(10) DEFAULT NULL";
        $msg = $this->performdb($query);
        if (!$msg) {
            $messages[] = '<font color="green">' . JText::_('JBS_IBM_QUERY_SUCCESS') . ': ' . $query . ' </font><br /><br />';
        } else {
        ...
        $query = "ALTER TABLE #__bsms_mediafiles MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, ADD COLUMN asset_id INT(10) DEFAULT NULL, ADD COLUMN access INT(10) DEFAULT NULL";
        $msg = $this->performdb($query);
        if (!$msg) {
            $messages[] = '<font color="green">' . JText::_('JBS_IBM_QUERY_SUCCESS') . ': ' . $query . ' </font><br /><br />';
        } else {
        ...
        $query = "ALTER TABLE #__bsms_studies MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, ADD COLUMN asset_id INT(10) DEFAULT NULL, ADD COLUMN access INT(10) DEFAULT NULL";
        $msg = $this->performdb($query);
        if (!$msg) {
            $messages[] = '<font color="green">' . JText::_('JBS_IBM_QUERY_SUCCESS') . ': ' . $query . ' </font><br /><br />';
        } else {
        ...
        $query = "ALTER TABLE #__bsms_teachers MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, ADD COLUMN asset_id INT(10) DEFAULT NULL, ADD COLUMN access INT(10) DEFAULT NULL";
        $msg = $this->performdb($query);
        if (!$msg) {
            $messages[] = '<font color="green">' . JText::_('JBS_IBM_QUERY_SUCCESS') . ': ' . $query . ' </font><br /><br />';
        } else {
        ...
        $query = "ALTER TABLE #__bsms_topics MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, ADD COLUMN asset_id INT(10) DEFAULT NULL, ADD COLUMN access INT(10) DEFAULT NULL";
        $msg = $this->performdb($query);
        if (!$msg) {
            $messages[] = '<font color="green">' . JText::_('JBS_IBM_QUERY_SUCCESS') . ': ' . $query . ' </font><br /><br />';
        } else {
