...
class JBSMStatistics
{
	...
	/**
	 * @return JBSMStatistics
	 */
	public static function getInstance()
	{
		if (self::$_instance === null)
		{
			self::$_instance = new JBSMStatistics();
		}
	...
	public function loadCategoryCount()
	{
		if ($this->sectionCount === null)
		{
			...
			$categories = JBSMCategoryHelper::getCategories(false, false, 'none');
	...
	public function loadTopTopics($limit = 0)
	{
		...
		if (count($this->topTopics) < $limit)
		{
			...
			list($total, $this->topTopics) = JBSMTopicHelper::getLatestTopics(false, 0, $limit, $params);
	...
	public function loadTopPolls($limit = 0)
	{
		...
		if (count($this->topPolls) < $limit)
		{
			...
			KunenaError::checkDatabaseError();
			$this->topPolls = JBSMTopicHelper::getTopics(array_keys($polls));
