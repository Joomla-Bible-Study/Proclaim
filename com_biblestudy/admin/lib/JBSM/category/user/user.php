 ...
 *
 */
class JBSMCategoryUser extends JObject
{
	...
	{
		return JBSMCategoryUserHelper::get($id, $user, $reload);
	}
	...
	/**
	 * Method to load a JBSMCategoryUser object by id.
	 *
	...
	/**
	 * Method to save the JBSMCategoryUser object to the database.
	 *
	...
	public function save($updateOnly = false)
	{
		...
		// Fill up JBSMCategoryUser object in case we created a new category.
		if ($result && $isnew)
		{
			$this->load ();
		}
	...
	/**
	 * Method to delete the JBSMCategoryUser object from the database.
	 *
	 * @return bool	True on success
	 */
