 ...
 */
class JBSMAnnouncement extends KunenaDatabaseObject
{
	...
	/**
	 * Returns the global JBSMAnnouncement object.
	 *
	...
	{
		return JBSMAnnouncementHelper::get($identifier, $reload);
	}
