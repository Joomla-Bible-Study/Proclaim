...
/**
 * Class JBSMAnnouncementHelper
 */
abstract class JBSMAnnouncementHelper
{
	/**
	 * @var JBSMAnnouncement[]
	 */
	public static $_instances = false;

	/**
	 * Returns the global JBSMAnnouncement object, only creating it if it doesn't already exist.
	 *
	 * @param int $identifier	Announcement to load - Can be only an integer.
	 * @param bool $reload
	 *
	 * @return JBSMAnnouncement
	 */
	static public function get($identifier = null, $reload = false)
	{
		if ($identifier instanceof JBSMAnnouncement)
		{
			return $identifier;
		}
		...
		{
			self::$_instances [$id] = new JBSMAnnouncement (array('id'=>$id));
	...
	static public function getAnnouncements($start = 0, $limit = 1, $filter = true)
	{
		...
		foreach ( $results as $announcement )
		{
			...
			$instance = new JBSMAnnouncement ($announcement);
