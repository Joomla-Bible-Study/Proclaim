...
/**
 * Class JBSMMessageFinder
 */
class JBSMMessageFinder extends KunenaDatabaseObjectFinder
{
	 ...
	 * @return array|JBSMMessage[]
	 */
	public function find($access = 'read')
	{
		$results = parent::find();

		return JBSMMessageHelper::getMessages($results, $access);
	}
