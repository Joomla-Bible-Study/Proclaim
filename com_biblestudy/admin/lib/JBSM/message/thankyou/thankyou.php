 ...
 */
class JBSMMessageThankyou extends JObject
{
	/**
	 * @var int
	 */
	...
	{
		return JBSMMessageThankyouHelper::get($identifier, $reload);
	}
	...
	public function save($user)
	{
		...
		$message = JBSMMessageHelper::get($this->id);
	 ...
	 * @return bool
	 */
	protected function _savethankyou(JBSMMessage $message)
	{
		$db = JFactory::getDBO ();
