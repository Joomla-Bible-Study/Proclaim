 ...
 * @since 2.0
 */
abstract class JBSMMessageThankyouHelper
{
	/**
	 * @var JBSMMessageThankyou[]
	 */
	...
	{
		if ($identifier instanceof JBSMMessageThankyou)
		{
			return $identifier;
		}
	...
	{
		$db = JFactory::getDBO();
		$categories = JBSMCategoryHelper::getCategories();
	...
	static protected function loadMessages(array $ids)
	{
		...
		foreach ($ids as $id)
		{
			self::$_instances [$id] = new JBSMMessageThankyou ($id);
		}
