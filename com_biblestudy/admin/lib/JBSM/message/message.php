 ...
 */
class JBSMMessage extends KunenaDatabaseObject
{
	/**
	 * @var int
	 */
	...
	{
		return JBSMMessageHelper::get($identifier, $reload);
	}
	...
	public function isNew($user = null)
	{
		...
		$allreadtime = JBSMCategoryUserHelper::get($this->getCategory(), $user)->allreadtime;
		...
		$read = JBSMTopicUserReadHelper::get($this->getTopic(), $user);
	...
	/**
	 * @param null|JBSMCategory $category	Fake category if needed. Used for aliases.
	 * @param bool $xhtml
	 *
	 * @return string
	 */
	...
	/**
	 * @param null|JBSMCategory $category
	 *
	 * @return JUri
	 */
	...
	public function getTopic()
	{
		if (!$this->_topic)
		{
			$this->_topic = JBSMTopicHelper::get($this->thread);
		}
	 ...
	 */
	public function setTopic(JBSMTopic $topic)
	{
		$this->_topic = $topic;
	...
	/**
	 * @return JBSMMessageThankyou
	 */
	public function getThankyou()
	{
		return JBSMMessageThankyouHelper::get($this->id);
	}
	...
	{
		return JBSMCategoryHelper::get($this->catid);
	}
	...
	{
		return JBSMMessageHelper::get($this->parent);
	}
	...
	/**
	 * Method to load a JBSMMessage object by id.
	 *
	...
	/**
	 * Method to save the JBSMMessage object to the database.
	 *
	...
	/**
	 * Method to delete the JBSMMessage object from the database.
	 *
	 * @return bool	True on success
	 */
	...
	protected function update($newTopic = false)
	{
		...
		{
			$topic = JBSMTopicHelper::get($this->_thread);
