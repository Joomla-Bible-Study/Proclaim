 ...
 */
class JBSMTopicPoll extends JObject
{
	...
	{
		return JBSMTopicPollHelper::get($identifier, $reset);
	}
	...
	/**
	 * Method to load a JBSMTopicPoll object by id.
	 *
	...
	/**
	 * Method to delete the JBSMTopicPoll object from the database.
	 *
	...
	public function delete()
	{
		...
		$topic = JBSMTopicHelper::get($this->threadid);
	...
	/**
	 * Method to save the JBSMTopicPoll object to the database.
	 *
	...
	public function save($updateOnly = false)
	{
		...
		// Set the id for the JBSMTopic object in case we created a new topic.
		if ($isnew)
		{
			$this->load ( $table->id );
			$this->options = array();
