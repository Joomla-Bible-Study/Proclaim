 ...
 * @property int $time
 */
class JBSMTopicUserRead extends JObject
{
	 ...
	 * @param bool  $reload
	 *
	 * @return JBSMTopicUserRead
	 */
	static public function getInstance($id = null, $user = null, $reload = false)
	{
		return JBSMTopicUserReadHelper::get($id, $user, $reload);
	}
	...
	{
		return JBSMTopicUserReadHelper::get($this->topic_id);
	}
	...
	/**
	 * Method to load a JBSMTopicUserRead object by id.
	 *
	...
	/**
	 * Method to save the JBSMTopicUserRead object to the database.
	 *
	...
	public function save($updateOnly = false)
	{
		...
		// Fill up JBSMTopicUserRead object in case we created a new topic.
		if ($result && $isnew)
		{
			$this->load ();
		}
	...
	/**
	 * Method to delete the JBSMTopicUserRead object from the database.
	 *
	 * @return bool	True on success.
	 */
