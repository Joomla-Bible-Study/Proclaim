 ...
 */
class JBSMTopicUser extends JObject
{
	...
	{
		return JBSMTopicUserHelper::get($id, $user, $reload);
	}
	...
	{
		return JBSMTopicHelper::get($this->topic_id);
	}
	...
	/**
	 * Method to load a JBSMTopicUser object by id.
	 *
	...
	/**
	 * Method to save the JBSMTopicUser object to the database.
	 *
	...
	public function save($updateOnly = false)
	{
		...
		// Fill up JBSMTopicUser object in case we created a new topic.
		if ($result && $isnew) {
			$this->load ();
		}
	...
	/**
	 * Method to delete the JBSMTopicUser object from the database.
	 *
	 * @return bool	True on success.
	 */
	 ...
	 * @return bool|null
	 */
	function update(JBSMMessage $message = null, $postDelta = 0)
	{
