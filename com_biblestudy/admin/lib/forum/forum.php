 ...
 */
abstract class BibleStudyForum
{
	...
	public static function enabled($checkAdmin = true)
	{
		...
		return !$config->board_offline
			|| ($checkAdmin && self::installed() && BibleStudyUserHelper::getMyself()->isAdmin());
	}
	...
	public static function display($viewName, $layout='default', $template=null, $params = array())
	{
		...
		require_once BIBLESTUDY_PATH . '/views/common/view.html.php';
		require_once BIBLESTUDY_PATH . '/models/common.php';
...
//		if ($viewName != 'common')
//		{
//			$view->common = new BibleStudyViewCommon ( array ('base_path' => BIBLESTUDY_PATH ) );
...
//		}
	...
	protected static function buildVersion()
	{
		...
		self::$version_date = ('2015-11-16' == '@' . 'biblestudyversiondate' . '@') ? JFactory::getDate()->format('Y-m-d') : '2015-11-16';
		self::$version_name = ('Albareto' == '@' . 'biblestudyversionname' . '@') ? 'Git Repository' : 'Albareto';
	}
}
