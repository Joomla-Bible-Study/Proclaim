	...
	<?php if (!$this->updateInfo->supported): ?>
		<div class="liveupdate-notsupported">
			...
			<p class="liveupdate-buttons">
				<button
					onclick="window.location='<?php echo $this->requeryURL ?>'"><?php echo JText::_('LIVEUPDATE_REFRESH_INFO') ?></button>
			</p>
		</div>
		...
		<div class="liveupdate-<?php echo $class ?>">
			...
			<div class="liveupdate-infotable">
				...
				<div class="liveupdate-row row1">
					...
					<span class="liveupdate-data"><a
							href="<?php echo $this->updateInfo->downloadURL . $auth ?>"><?php echo $this->escape($this->updateInfo->downloadURL) ?></a></span>
				</div>
			...
			<p class="liveupdate-buttons">
				<?php if ($this->updateInfo->hasUpdates): ?>
					...
					<button <?php echo $disabled ?>
						onclick="window.location='<?php echo $this->runUpdateURL ?>'"><?php echo JText::_('LIVEUPDATE_DO_UPDATE') ?></button>
				<?php endif; ?>
				<button
					onclick="window.location='<?php echo $this->requeryURL ?>'"><?php echo JText::_('LIVEUPDATE_REFRESH_INFO') ?></button>
			</p>
