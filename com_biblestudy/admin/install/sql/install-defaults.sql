...
--
-- Dumping data for table `r9s7a_bsms_admin`
--

INSERT INTO `r9s7a_bsms_admin` (`id`, `drop_tables`, `params`, `asset_id`, `access`) VALUES
...
--
-- Dumping data for table `r9s7a_bsms_books`
--

INSERT INTO `r9s7a_bsms_books` (`id`, `bookname`, `booknumber`, `published`) VALUES
...
--
-- Dumping data for table `r9s7a_bsms_folders`
--

INSERT INTO `r9s7a_bsms_folders` (`id`, `foldername`, `folderpath`, `published`, `asset_id`, `access`) VALUES
(1, 'My Folder Name', '/media/', 1, 0, 1);

--
-- Dumping data for table `r9s7a_bsms_locations`
--

INSERT INTO `r9s7a_bsms_locations` (`id`, `location_text`, `published`, `asset_id`, `access`, `ordering`) VALUES
(1, 'My Location', 1, 0, 1, 1);

--
-- Dumping data for table `r9s7a_bsms_media`
--

INSERT INTO `r9s7a_bsms_media` (`id`, `media_text`, `media_image_name`, `media_image_path`, `path2`, `media_alttext`, `published`, `asset_id`, `access`, `ordering`) VALUES
...
--
-- Dumping data for table `r9s7a_bsms_mediafiles`
--

INSERT INTO `r9s7a_bsms_mediafiles` (`id`, `study_id`, `media_image`, `server`, `path`, `special`, `filename`, `size`, `mime_type`, `podcast_id`, `internal_viewer`, `mediacode`, `ordering`, `createdate`, `link_type`, `hits`, `published`, `docMan_id`, `article_id`, `comment`, `virtueMart_id`, `downloads`, `plays`, `params`, `player`, `popup`, `asset_id`, `access`, `language`) VALUES
...
--
-- Dumping data for table `r9s7a_bsms_message_type`
--

INSERT INTO `r9s7a_bsms_message_type` (`id`, `message_type`, `alias`, `published`, `asset_id`, `access`, `ordering`) VALUES
(1, 'Sunday', 'sunday', 1, 0, 1, 1);

--
-- Dumping data for table `r9s7a_bsms_mimetype`
--

INSERT INTO `r9s7a_bsms_mimetype` (`id`, `mimetype`, `mimetext`, `published`, `asset_id`, `access`, `ordering`) VALUES
...
--
-- Dumping data for table `r9s7a_bsms_order`
--

INSERT INTO `r9s7a_bsms_order` (`id`, `value`, `text`) VALUES
(1, 'ASC', 'JBS_CMN_ASCENDING'),
(2, 'DESC', 'JBS_CMN_DESCENDING');

--
-- Dumping data for table `r9s7a_bsms_podcast`
--

INSERT INTO `r9s7a_bsms_podcast` (`id`, `title`, `website`, `description`, `image`, `imageh`, `imagew`, `author`, `podcastimage`, `podcastsearch`, `filename`, `language`, `editor_name`, `editor_email`, `podcastlimit`, `published`, `episodetitle`, `custom`, `detailstemplateid`, `asset_id`, `access`) VALUES
...
--
-- Dumping data for table `r9s7a_bsms_series`
--

INSERT INTO `r9s7a_bsms_series` (`id`, `series_text`, `alias`, `teacher`, `description`, `series_thumbnail`, `published`, `asset_id`, `ordering`, `access`, `language`) VALUES
(1, 'Worship Series', 'worship-series', -1, '', '', 1, 0, 1, 1, '*');

--
-- Dumping data for table `r9s7a_bsms_servers`
--

INSERT INTO `r9s7a_bsms_servers` (`id`, `server_name`, `server_path`, `published`, `server_type`, `ftp_username`, `ftp_password`, `asset_id`, `access`, `type`, `ftphost`, `ftpuser`, `ftppassword`, `ftpport`, `aws_key`, `aws_secret`) VALUES
(1, 'Your Server Name', 'www.mywebsite.com', 1, 'local', '', '', 0, 1, 0, '', '', '', '', '', '');

--
-- Dumping data for table `r9s7a_bsms_share`
--

INSERT INTO `r9s7a_bsms_share` (`id`, `name`, `params`, `published`, `asset_id`, `access`, `ordering`) VALUES
...
--
-- Dumping data for table `r9s7a_bsms_styles`
--

INSERT INTO `r9s7a_bsms_styles` (`id`, `published`, `filename`, `stylecode`, `asset_id`) VALUES
...
--
-- Dumping data for table `r9s7a_bsms_teachers`
--

INSERT INTO `r9s7a_bsms_teachers` (`id`, `teacher_image`, `teacher_thumbnail`, `teachername`, `alias`, `title`, `phone`, `email`, `website`, `information`, `image`, `imageh`, `imagew`, `thumb`, `thumbw`, `thumbh`, `short`, `ordering`, `catid`, `list_show`, `published`, `asset_id`, `access`, `language`) VALUES
...
--
-- Dumping data for table `r9s7a_bsms_templates`
--

INSERT INTO `r9s7a_bsms_templates` (`id`, `type`, `tmpl`, `published`, `params`, `title`, `text`, `pdf`, `asset_id`, `access`) VALUES
...
--
-- Dumping data for table `r9s7a_bsms_timeset`
--

INSERT INTO `r9s7a_bsms_timeset` (`timeset`, `backup`) VALUES
('1281646339', '1281646339');

--
-- Dumping data for table `r9s7a_bsms_topics`
--

INSERT INTO `r9s7a_bsms_topics` (`id`, `topic_text`, `published`, `params`, `asset_id`, `access`) VALUES
