...
INSERT INTO `#__bsms_mediafiles` (`id`, `study_id`, `server_id`, `podcast_id`, `params`, `metadata`, `downloads`, `plays`, `hits`, `player`, `ordering`, `createdate`, `published`, `comment`, `asset_id`, `access`, `language`, `created_by`, `created_by_alias`, `modified`, `modified_by`)
VALUES
  (1, 1, 1, '1',
   '{"link_type":"","docMan_id":"0","article_id":"-1","virtueMart_id":"0","player":"","popup":"","mediacode":"","filename":"\/\/www.calvarychapelnewberg.net\/MediaFiles\/2014\/2014-004.mp3","size":"","special":"","localFolder":"","playerwidth":"","playerheight":"","itempopuptitle":"","itempopupfooter":"","popupmargin":"50","autostart":""}',
...
INSERT INTO `#__bsms_series` (`id`, `series_text`, `alias`, `teacher`, `description`, `series_thumbnail`, `published`, `asset_id`, `ordering`, `access`, `language`)
VALUES
...
INSERT INTO `#__bsms_teachers` (`id`, `teacher_image`, `teacher_thumbnail`, `teachername`, `alias`, `title`, `phone`, `email`, `website`, `information`, `image`, `imageh`, `imagew`, `thumb`, `thumbw`, `thumbh`, `short`, `ordering`, `catid`, `list_show`, `published`, `asset_id`, `access`, `language`)
VALUES
  (1, '', '', 'Billy Sunday', 'billy-sunday', 'Pastor', '555-555-5555', 'billy@sunday.com', 'http://billysunday.com',
   ...
   '141', 'Billy Sunday: 1862-1935', 0, 1, 1, 1, 0, 1, '*');
