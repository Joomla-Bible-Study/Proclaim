...
function installSampleData()
{
	...
	$query = "INSERT INTO `#__bsms_admin` (`id`, `drop_tables`, `params`, `asset_id`, `access`, `installstate`, `debug`)
VALUES
(1, 0,
	...
	$queries[] = array('bsms_admin', $query);

	$query = "INSERT INTO `#__bsms_books` (`id`, `bookname`, `booknumber`, `published`)
VALUES
...
VALUES
  (1, 'My Location', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, '0000-00-00 00:00:00', '', 0,
   ...
   '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 7480, 1, 1, NULL);";
	...
	$queries[] = array('bsms_locations', $query);

	$query = "INSERT INTO `#__bsms_mediafiles` (`id`, `study_id`, `server_id`, `podcast_id`, `metadata`, `ordering`, `createdate`, `hits`, `published`, `comment`, `downloads`, `plays`, `params`, `asset_id`, `access`, `language`, `created_by`, `created_by_alias`, `modified`, `modified_by`, `checked_out`, `checked_out_time`)
VALUES
  ...
  (3, 1, 2, '', '', 0, '2015-07-28 19:18:07', 0, 1, '', 0, 0,
   ...
   7596, 1, '*', 0, '', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00');";
	...
	$queries[] = array('bsms_mediafiles', $query);

	$query = "INSERT INTO `#__bsms_message_type` (`id`, `message_type`, `alias`, `published`, `asset_id`, `access`, `ordering`, `landing_show`)
VALUES
  (1, 'Sunday', X'73756E646179', 1, 7482, 1, 1, NULL);";

	$queries[] = array('bsms_message_type', $query);
...
VALUES
  (1, 'My Podcast', 'www.mywebsite.com', 'Podcast Description goes here', 'www.mywebsite.com/myimage.jpg', 30, 30,
   ...
   50, 1, 0, '', 1, 7483, 1, '', '', 0, '', '', '', 0, '', 0);";
	...
	$queries[] = array('bsms_podcast', $query);

	$query = "INSERT INTO `#__bsms_series` (`id`, `series_text`, `alias`, `teacher`, `description`, `series_thumbnail`, `published`, `asset_id`, `ordering`, `access`, `language`, `landing_show`)
VALUES
  (1, 'Worship Series', X'776F72736869702D736572696573', -1, '', '', 1, 7484, 1, 1, '*', NULL);";

	$queries[] = array('bsms_series', $query);

	$query = "INSERT INTO `#__bsms_servers` (`id`, `server_name`, `published`, `asset_id`, `access`, `type`, `params`, `media`)
VALUES
  ...
  (3, 'Legacy PDF', 1, 7589, 1, 'legacy',
   ...
   '{\"link_type\":\"1\",\"player\":\"0\",\"popup\":\"2\",\"mediacode\":\"\",\"media_image\":\"images\\ / biblestudy\\ / pdf16 . png\",\"mime_type\":\"application\\ / pdf\",\"autostart\":\"1\"}');";
	...
	$queries[] = array('bsms_servers', $query);
...
VALUES
  (1, '2010-03-13 00:10:00', 1, '2015-01', 151, 3, 5, 3, 11, '', '-1', '', '', '', '', NULL, NULL, NULL, NULL, NULL,
   ...
   '*', -1);";
	...
	$queries[] = array('bsms_studies', $query);

	$query = "INSERT INTO `#__bsms_studytopics` (`id`, `study_id`, `topic_id`, `asset_id`, `access`)
VALUES
  (3, 1, 114, 7594, 1),
  (4, 1, 114, 7595, 1);";

	$queries[] = array('bsms_studytopics', $query);

	$query = "INSERT INTO `#__bsms_styles` (`id`, `published`, `filename`, `stylecode`, `asset_id`)
VALUES
  (1, 1, 'biblestudy',
   ...
   7586);";
	...
	$queries[] = array('bsms_styles', $query);

	$query = "INSERT INTO `#__bsms_teachers` (`id`, `teacher_image`, `teacher_thumbnail`, `teachername`, `alias`, `title`, `phone`, `email`, `website`, `information`, `image`, `imageh`, `imagew`, `thumb`, `thumbw`, `thumbh`, `short`, `ordering`, `catid`, `list_show`, `published`, `asset_id`, `access`, `language`, `facebooklink`, `twitterlink`, `bloglink`, `link1`, `linklabel1`, `link2`, `linklabel2`, `link3`, `linklabel3`, `contact`, `address`, `landing_show`, `address1`)
VALUES
  (1, '', '', 'Billy Sunday', X'62696C6C792D73756E646179', 'Pastor', '555-555-5555', 'billy@sunday.com',
   ...
   NULL, '', NULL, '');";
	...
	$queries[] = array('bsms_teachers', $query);

	$query = "INSERT INTO `#__bsms_templates` (`id`, `type`, `tmpl`, `published`, `params`, `title`, `text`, `pdf`, `asset_id`, `access`)
VALUES
  (1, 'tmplList', '', 1,
   '{\"useterms\":\"0\",\"terms\":\"\",\"css\":\"biblestudy . css\",\"studieslisttemplateid\":\"1\",\"sermonstemplate\":\"0\",\"detailstemplateid\":\"1\",\"sermontemplate\":\"0\",\"teachertemplateid\":\"1\",\"teachertemplate\":\"0\",\"teacherstemplate\":\"0\",\"serieslisttemplateid\":\"1\",\"seriesdisplaystemplate\":\"0\",\"seriesdetailtemplateid\":\"1\",\"seriesdisplaytemplate\":\"0\",\"offset\":\"false\",\"teacher_id\":[\" - 1\"],\"series_id\":[\" - 1\"],\"booknumber\":[\" - 1\"],\"topic_id\":[\" - 1\"],\"messagetype\":[\" - 1\"],\"locations\":[\" - 1\"],\"show_verses\":\"0\",\"stylesheet\":\"\",\"date_format\":\"2\",\"custom_date_format\":\"\",\"duration_type\":\"2\",\"protocol\":\"http:\\ / \\ / \",\"player\":\"0\",\"popuptype\":\"window\",\"internal_popup\":\"1\",\"special\":\"_blank\",\"autostart\":\"1\",\"playerresposive\":\"1\",\"player_width\":\"400\",\"player_height\":\"300\",\"embedshare\":\"TRUE\",\"backcolor\":\"0x287585\",\"frontcolor\":\"0xFFFFFF\",\"lightcolor\":\"0x000000\",\"screencolor\":\"0x000000\",\"popuptitle\":\"{
	{
		title}
}\",\"popupfooter\":\"{
	{
		filename}
}\",\"popupmargin\":\"50\",\"popupbackground\":\"black\",\"popupimage\":\"media\\ / com_biblestudy\\ / images\\ / speaker24 . png\",\"show_filesize\":\"1\",\"playerposition\":\"over\",\"playeridlehide\":\"1\",\"useexpert_list\":\"0\",\"headercode\":\"\",\"templatecode\":\"                                   {
	{
		teacher}
}             {
	{
  ...
  (114, 'JBS_TOP_RAIN', 1, NULL, 7590, '*', 1);";
	...
	foreach ($queries as $query)
	{
		...
		if (!$filled)
		{
			...
			$db->execute();
			if ($db->getErrorNum())
				throw new JBSMInstallerException ($db->getErrorMsg(), $db->getErrorNum());
			$counter++;
		}
	}
