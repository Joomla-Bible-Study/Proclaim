...
<div id="kunena" style="max-width:530px">
	<div id="kunena-install">
		...
		<div>
			<div id="kunena-description"><?php echo JText::_('COM_BIBLESTUDY_INSTALL_PREPARING'); ?></div>
	...
	<div>
		<button id="kunena-toggle" class="btn" style="float: left;"><?php echo JText::_('COM_BIBLESTUDY_INSTALL_DETAILS'); ?></button>
		<div class="pull-right">
			<button id="kunena-component" class="btn kunena-close" disabled="disabled"><?php echo JText::_('COM_BIBLESTUDY_INSTALL_TO_KUNENA'); ?></button>
			<button id="kunena-installer" class="btn kunena-close" disabled="disabled" data-dismiss="modal" aria-hidden="true"><?php echo JText::_('COM_BIBLESTUDY_INSTALL_CLOSE'); ?></button>
		</div>
		<div id="kunena-container" class="hidden">
			<p class="clr clearfix"></p>
			<div id="kunena-details" class="well well-small"><h4><?php echo JText::_('COM_BIBLESTUDY_INSTALL_DETAILS'); ?></h4><div><?php echo JText::_('COM_BIBLESTUDY_INSTALL_PREPARING'); ?></div></div>
		</div>
	</div>
</div>
<script>
...
window.kunenainstall = function() {
	...
	jQuery.ajax({
		...
		error: function (xhr, ajaxOptions, thrownError) {
			kunenaInstall.html('<h2><?php echo JText::_('COM_BIBLESTUDY_INSTALL_ERROR_MESSAGE', true); ?></h2><div><?php echo JText::_('COM_BIBLESTUDY_INSTALL_ERROR_DETAILS', true); ?></div><div>' + xhr.responseText + '</div>');
		...
		success: function (json) {
			...
			if (json.success) {
				...
				if (json.status != '100%') {
					...
					kunenaInstall.find('h2').text('<?php echo JText::_('COM_BIBLESTUDY_INSTALL_SUCCESS_MESSAGE', true); ?>');
				...
				kunenaProgress.parent().removeClass('active');
				kunenaInstall.find('h2').text('<?php echo JText::_('COM_BIBLESTUDY_INSTALL_ERROR_MESSAGE', true); ?>');
