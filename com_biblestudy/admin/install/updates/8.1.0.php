	...
	public function up($db)
	{
		...
		foreach($db->loadObjectList() as $server) {
			...
			foreach($db->loadObjectList() as $mediaFile) {
				...
				// Delete unused columns
				$columns = array('media_image', 'special', 'filename', 'size', 'mime_type', 'mediacode', 'link_type', 'docMan_id', 'article_id', 'virtueMart_id', 'player', 'popup', 'server', 'internal_viewer', 'hits', 'downloads', 'plays', 'path');
