...
class JFormFieldServerType extends JFormFieldList {
    protected function getInput() {
        ...
        $html[] = '    <a class="btn" onclick="SqueezeBox.fromElement(this, {handler:\'iframe\', size: {x: 600, y: 450}, url:\''.JRoute::_('index.php?option=com_biblestudy&view=servers&layout=types&tmpl=component&recordId='.$recordId).'\'})"><i class="icon-list"></i> '.JText::_('JSELECT').'</a>';
