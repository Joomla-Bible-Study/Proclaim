<?php
/**
 * @version		$Id: teacherdisplay.php 2010-12-22 Based on com_newsfeeds
...
class JFormFieldModal_Teacherdisplay extends JFormField
{
	...
	protected function getInput()
	{
		...
		$link = 'index.php?option=com_biblestudy&amp;view=teacherlist&amp;layout=modal&amp;tmpl=component&amp;function=jSelectChart_'.$this->id;

		JHTML::_('behavior.modal', 'a.modal');
		$html = "\n".'<div class="fltlft"><input type="text" id="'.$this->id.'_name" value="'.htmlspecialchars($title, ENT_QUOTES, 'UTF-8').'" disabled="disabled" /></div>';
		$html .= '<div class="button2-left"><div class="blank"><a class="modal" title="'.JText::_('JBS_CMN_SELECT_TEACHER').'"  href="'.$link.'" rel="{handler: \'iframe\', size: {x: 800, y: 450}}">'.JText::_('JBS_CMN_SELECT_TEACHER').'</a></div></div>'."\n";
