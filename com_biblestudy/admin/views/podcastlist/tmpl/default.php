...
?>
<form
	action="<?php echo JRoute::_('index.php?option=com_biblestudy&view=podcastlist'); ?>"
	...
	<table class="adminlist">
		...
		?>
			<tr class="row<?php echo $i % 2; ?>">
				...
				<td class="center"><a
					href="<?php echo JRoute::_('index.php?option=com_biblestudy&task=podcastedit.edit&id='.(int)$item->id); ?>">
