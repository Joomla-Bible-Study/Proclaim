        ...
        <fieldset class="panelform">
            ...
            <ul>
                <li><?php echo $this->templates; ?></td><?php  ?>
                    <input type="submit" value="Submit" onclick="Joomla.submitbutton('templates.template_export')"/>
                </li>
            </ul>
        </fieldset>
    </div>
        ...
        <fieldset class="panelform">
            ...
            <ul>
                <li><input class="input_box" id="template_import" name="template_import" type="file" size="57"/>
                    <input type="submit" value="Submit" onclick="Joomla.submitbutton('templates.template_import')"/>
                </li>
            </ul>
        </fieldset>
    </div>
