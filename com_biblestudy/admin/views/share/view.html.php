 ...
 * @since 7.0.0
 */
class BiblestudyViewShare extends JView {
    ...
    public function display($tpl = null) {
        ...
        $this->canDo = BibleStudyHelper::getActions($this->item->id, 'share');
        $this->setLayout("form");
        // Set the toolbar
        $this->addToolbar();
    ...
    protected function setDocument() {
        ...
        $document->setTitle($isNew ? JText::_('JBS_TITLE_SOCIAL_NETWORKING_LINKS_CREATING') : JText::sprintf('JBS_TITLE_SOCIAL_NETWORKING_LINKS_EDITING', $this->item->name));
    }
