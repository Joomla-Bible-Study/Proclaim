    ...
    <table class="table table-striped adminlist" id="serversList">
        ...
        <tr>
           ...
           <th width="1%">
            ...
            <th>
                <?php echo JHtml::_('grid.sort', 'JBS_CMN_SERVERS', 'servers.server_name', $listDirn, $listOrder); ?>
            </th>
           
            <th width="1%" class="nowrap hidden-phone">
                <?php echo JHtml::_('grid.sort', 'JGRID_HEADING_ID', 'servers.id', $listDirn, $listOrder); ?>
            </th>
        </tr>
        </thead>
        <tbody>
        ...
        <tr class="row<?php echo $i % 2; ?>" sortable-group-id="<?php echo $item->id ?>">
            ...
            <td class="center">
                <div class="btn-group">
                    <?php echo JHtml::_('jgrid.published', $item->published, $i, 'servers.', $canChange, 'cb', '', ''); ?>
                </div>
            </td>
            <td class="nowrap has-context">
                <div class="pull-left">
                    ...
                    <a href="<?php echo JRoute::_('index.php?option=com_biblestudy&task=server.edit&id=' . (int) $item->id); ?>" title="<?php echo JText::_('JACTION_EDIT'); ?>">
                        <?php echo $this->escape($item->server_name); ?></a>
                    <?php else : ?>
                    <span title="<?php echo JText::sprintf('JFIELD_ALIAS_LABEL', $this->escape($item->server_name)); ?>"><?php echo $this->escape($item->server_name); ?></span>
                    <?php endif; ?>
                </div>
                <div class="pull-left">
                    <?php
