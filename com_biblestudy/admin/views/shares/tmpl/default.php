...
<form action="<?php echo JRoute::_('index.php?option=com_biblestudy&view=shares'); ?>" method="post" name="adminForm"
      id="adminForm">
		...
		<div id="j-main-container">
			...
			<table class="table table-striped adminlist" id="messagetypeslist">
				...
				foreach ($this->items as $i => $item) :
					...
					$canEdit            = $user->authorise('core.edit', 'com_biblestudy.share.' . $item->id);
					$canEditOwn         = $user->authorise('core.edit.own', 'com_biblestudy.share.' . $item->id);
					$canChange          = $user->authorise('core.edit.state', 'com_biblestudy.share.' . $item->id);
					?>
