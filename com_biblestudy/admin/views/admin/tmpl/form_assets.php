    ...
    <div class="width-100">
        <div class="width-60 fltlft">
            <fieldset class="panelform">
                ...
                <div>
                    <table ><tr><td >
                                <a href="index.php?option=com_biblestudy&view=admin&id=1&task=admin.checkassets"><img src="<?php echo JURI::base() . '/components/com_biblestudy/images/icons/import.png'; ?>" alt="Check Assets" height="48" width="48" /></a>
                            </td><td >
                                <a href="index.php?option=com_biblestudy&view=admin&id=1&task=admin.fixAssets"><img src="<?php echo JURI::base() . '/components/com_biblestudy/images/icons/export.png'; ?>" alt="Fix Assets" height="48" width="48" /></a>
                            </td></tr>
