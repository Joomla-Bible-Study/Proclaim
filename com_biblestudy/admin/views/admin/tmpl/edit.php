...
<form action="<?php echo JRoute::_('index.php?option=com_biblestudy&view=admin&layout=edit&id=' . (int) $this->item->id); ?>"
...
<ul class="nav nav-tabs">
    ...
    <li><a href="#migrationtab" data-toggle="tab"><?php echo JText::_('JBS_IBM_MIGRATE'); ?></a></li>
	<?php endif; ?>
    <li><a href="#database" data-toggle="tab"><?php echo JText::_('JBS_ADM_DATABASE'); ?></a></li>
    <li><a href="#convert" data-toggle="tab"><?php echo JText::_('JBS_ADM_DATABASE'); ?></a></li>
</ul>
...
<?php if ($this->form->getValue('jbsmigrationshow', 'params') == 1) : ?>
<div class="tab-pane" id="migrationtab">
