...
<form action="<?php echo JRoute::_('index.php?option=com_biblestudy&view=folders'); ?>" method="post" name="adminForm"
        ...
        <tr class="row<?php echo $i % 2; ?>" sortable-group-id="<?php echo '1' ?>">
            ...
            <td class="nowrap has-context">
                <div class="pull-left">
					...
					<?php else : ?>
                    <span title="<?php echo JText::sprintf('JFIELD_ALIAS_LABEL', $this->escape($item->foldername)); ?>"><?php echo $this->escape($item->foldername); ?></span>
					<?php endif; ?>
                </div>
                <div class="pull-left">
					<?php
	...
	<?php if(BIBLESTUDY_CHECKREL) : if(BIBLESTUDY_CHECKREL) : echo $this->pagination->getListFooter(); else: echo $this->pagination->getPagesLinks(); endif; else: echo $this->pagination->getPagesLinks(); endif; ?>
