...
<form action="<?php echo JRoute::_('index.php?option=com_biblestudy&view=messagetypes'); ?>" method="post" name="adminForm" id="adminForm">
    ...
    <table class="table table-striped" id="messagetypeslist">
        ...
        <tr>
            ...
            <th>
                <?php echo JHtml::_('grid.sort', 'JBS_CMN_MESSAGE_TYPES', 'messagetypes.message_type', $listDirn, $listOrder); ?>
            </th>
        ...
        <tr class="row<?php echo $i % 2; ?>" sortable-group-id="<?php echo '1' ?>">
            ...
            <td class="nowrap has-context">
                <div class="pull-left">
                    ...
                    <a href="<?php echo JRoute::_('index.php?option=com_biblestudy&task=messagetype.edit&id=' . (int) $item->id); ?>" title="<?php echo JText::_('JACTION_EDIT'); ?>">
                        <?php echo $this->escape($item->message_type); ?></a>
                    <?php else : ?>
                    <span title="<?php echo JText::sprintf('JFIELD_ALIAS_LABEL', $this->escape($item->messsage_type)); ?>"><?php echo $this->escape($item->message_type); ?></span>
                    <?php endif; ?>
                </div>
                <div class="pull-left">
                    <?php
