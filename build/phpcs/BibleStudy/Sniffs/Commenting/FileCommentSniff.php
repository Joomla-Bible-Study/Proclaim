...
class BibleStudy_Sniffs_Commenting_FileCommentSniff implements PHP_CodeSniffer_Sniff
{
...
//    }//end processPHPVersion()
    ...
    {
        $docBlock    = (get_class($this) === 'BibleStudy_Sniffs_Commenting_FileCommentSniff') ? 'file' : 'class';
        ...
        foreach ($indentation as $indentInfo) {
            ...
            // BibleStudy change: allow for 2 space gap.
