...
if (class_exists('BibleStudy_Sniffs_Commenting_FileCommentSniff', true) === false) {
    $error = 'Class BibleStudy_Sniffs_Commenting_FileCommentSniff not found';
    throw new PHP_CodeSniffer_Exception($error);
}
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class BibleStudy_Sniffs_Commenting_ClassCommentSniff extends BibleStudy_Sniffs_Commenting_FileCommentSniff
{
