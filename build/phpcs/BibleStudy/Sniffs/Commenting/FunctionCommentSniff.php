 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class BibleStudy_Sniffs_Commenting_FunctionCommentSniff implements PHP_CodeSniffer_Sniff
{
    ...
    protected function processParams($commentStart)
    {
        ...
        if (empty($params) === false) {
            ...
            foreach ($params as $param) {
                ...
                // BibleStudy change: 3 spaces to make it line up with the @return tag with a 2 space gap.
			...
			// BibleStudy modification to 2 spaces.
