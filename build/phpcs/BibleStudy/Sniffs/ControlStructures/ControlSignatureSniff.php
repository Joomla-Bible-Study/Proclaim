 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class BibleStudy_Sniffs_ControlStructures_ControlSignatureSniff extends PHP_CodeSniffer_Standards_AbstractPatternSniff
{

	/**
	 * Constructs a BibleStudy_Sniffs_ControlStructures_ControlSignatureSniff.
	 */
	 ...
	 * Process a pattern.
	 *
	 * Returns if we are inside a "tmpl" folder - workaround for the BibleStudy! CMS :(
	 *
	...
	, $stackPtr)
	{
		...
		{
			/*
			 * @todo disabled - This is a special sniff for the BibleStudy! CMS to exclude
