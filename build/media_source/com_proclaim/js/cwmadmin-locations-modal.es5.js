(function () {
   ...
   */
  (function () {
    window.jSelectLocations = function (id, title, catid, object, link, lang) {
      var hreflang = '';
      ...
      var _Joomla$getOptions = Joomla.getOptions('xtd-locations'),
    ...
    document.addEventListener('DOMContentLoaded', function () {
      ...
      for (var i = 0, l = elements.length; l > i; i += 1) {
        elements[i].addEventListener('click', function (event) {
          ...
          if (functionName === 'jSelectLocations') {
