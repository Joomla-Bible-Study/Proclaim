...
Proclaim (CWM Proclaim) is a Joomla 6+ component (minimum 6.0.0; Joomla 5 support dropped at 11.0.0, #1966) for managing and displaying Bible studies/sermons. It supports teachers, series, topics, locations, media files, podcasting, and social sharing with customizable templates.
