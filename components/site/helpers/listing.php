...
function getListing($row, $params, $oddeven)
{
	...
	'; 
		...
		else {$elementid = getElementid($params->get('row1col1'), $row, $params);}
	...
	if ($columns > 1 && $params->get('r1c1span') < 2 )
	{
		...
		else {$elementid = getElementid($params->get('row1col2'), $row, $params);}
	...
	if ($columns > 2  && ( $params->get('r1c1span') < 3 && $params->get('r1c2span') < 2)) 
	{
		...
		else {$elementid = getElementid($params->get('row1col3'), $row, $params);}
	...
	if ($columns > 3 && ( $params->get('r1c1span') < 4 && $params->get('r1c2span') < 3 && $params->get('r1c3span') < 2))
	{
		...
		else {$elementid = getElementid($params->get('row1col4'), $row, $params);}
	...
	'; 
		...
		else {$elementid = getElementid($params->get('row2col1'), $row, $params);}
 		$colspan = $params->get('r2c1span');
 		$rowspan = $params->get('rowspanr2c1');;
		 $lastcol = 0;
		 if ($columns == 1 || $colspan > 3) {$lastcol = 1;}
		 $listing .= getCell($elementid->id, $elementid->element, $rowcolid, $colspan, $rowspan, $lastcol, $params->get('linkr2c1'), $id3, $tid, $smenu, $tmenu, $params->get('r2c1custom'));
	...
	if ($columns > 1  && $params->get('r2c1span') < 2)
	{
		...
		else {$elementid = getElementid($params->get('row2col2'), $row, $params);}
	...
	if ($columns > 2   && ( $params->get('r2c1span') < 3 && $params->get('r2c2span') < 2)) 
	{
		 ...
		 else {$elementid = getElementid($params->get('row2col3'), $row, $params);}
	...
	if ($columns > 3  && (  $params->get('r2c1span') < 4 && $params->get('r2c2span') < 3 && $params->get('r2c3span') < 2))
	{
		 ...
		 else {$elementid = getElementid($params->get('row2col4'), $row, $params);}
...
//Beginning of row 3
	...
	$listing .= '">'; 
		...
		else {$elementid = getElementid($params->get('row3col1'), $row, $params);}
	...
	if ($columns > 1 && $params->get('r3c1span') < 2)
	{
		...
		else {$elementid = getElementid($params->get('row3col2'), $row, $params);}
	...
	if ($columns > 2   && ( $params->get('r3c1span') < 3 && $params->get('r3c2span') < 2) )
	{
		...
		else {$elementid = getElementid($params->get('row3col3'), $row, $params);}
	...
	if ($columns > 3 && (  $params->get('r3c1span') < 4 && $params->get('r3c2span') < 3 && $params->get('r3c3span') < 2))
	{
		...
		else {$elementid = getElementid($params->get('row3col4'), $row, $params);}
...
//	$row4colspan = $params->get('r4c1span') + $params->get('r4c2span') + $params->get('r4c3span') + $params->get('r4c4span');
	...
	'; 
		...
		else {$elementid = getElementid($params->get('row4col1'), $row, $params);}
	...
	if ($columns > 1  && $params->get('r4c1span') < 2)
	{
		...
		else {$elementid = getElementid($params->get('row4col2'), $row, $params);}
	...
	if ($columns > 2   && ( $params->get('r4c1span') < 3 && $params->get('r4c2span') < 2) )
	{
		...
		else {$elementid = getElementid($params->get('row4col3'), $row, $params);}
	...
	if ($columns > 3 && ( $params->get('r4c1span') < 4 && $params->get('r4c2span') < 3 && $params->get('r4c3span') < 2))
	{
		...
		else {$elementid = getElementid($params->get('row4col4'), $row, $params);}
...
return $listing;
	...
	function getCell($elementid, $element, $rowcolid, $colspan, $rowspan, $lastcol, $islink, $id3, $tid, $smenu, $tmenu)
		{
			$cell .= '
