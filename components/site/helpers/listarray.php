...
$a = array( array(  'element' => '<div class = "scripture1'.$pageclass_sfx.'">'.$scripture1.'</div>',
  ...
  array( 'element' => '<div class = "studytitle'.$pageclass_sfx.'">'.$row->studytitle.'</div>',
  ...
  array( 'element' => '<div class = "duration'.$pageclass_sfx.'">'.$duration.'</div>',
  ...
  array( 'element' => '<div class = "studyintro'.$pageclass_sfx.'">'.$row->studyintro.'</div>',
  ...
  array( 'element' => '<div class = "studydate'.$pageclass_sfx.'">'.$date.'</div>',
  ...
  array( 'element' => '<div class = "teachername'.$pageclass_sfx.'">'.$row->teachername.'</div>',
  ...
  array( 'element' => '<div class = "teachertitle'.$pageclass_sfx.'">'.$row->teachername.' - '.$row->teachertitle.'</div>',
  ...
  array( 'element' => '<div class = "titleteacher'.$pageclass_sfx.'">'.$row->teachertitle.' - '.$row->teachername.'</div>',
  ...
  array( 'element' => '<div class = "filesize'.$pageclass_sfx.'">'.$file_size.'</div>',
  ...
  array( 'element' => '<div class = "series'.$pageclass_sfx.'">'.$row->series_text.'</div>',
  ...
  array( 'element' => '<div class = "secondary_reference'.$pageclass_sfx.'">'.$row->secondary_reference.'</div>',
  ...
  array( 'element' => '<div class = "scripture2'.$pageclass_sfx.'">'.$scripture2.'</div>',
  ...
  array( 'element' => '<div class = "submitted'.$pageclass_sfx.'">'.$row->user_name.'</div>',
  ...
  array( 'element' => '<div class = "hits'.$pageclass_sfx.'">'.$params->get('hits_label').': '.$row->hits.'</div>',
  ...
  array( 'element' => '<div class = "studynumber'.$pageclass_sfx.'">'.$row->studynumber.'</div>',
  ...
  array( 'element' => '<div class = "topic'.$pageclass_sfx.'">'.$row->topic_text.'</div>',
  ...
  array( 'element' => '<div class = "location'.$pageclass_sfx.'">'.$row->location_text.'</div>',
  ...
  array( 'element' => '<div class = "messagetype'.$pageclass_sfx.'">'.$row->message_type.'</div>',
