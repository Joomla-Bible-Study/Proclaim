					...
					<td>
						<table width="100%" border="0" cellspacing="1" cellpadding="1">
							<tr>
								...
								<?php 
									...
									if(isset($this->studies->id)) {
										echo ('
											<input type="hidden" name="study_id" id="study_id" value="'.$this->studies->id.'" />
										');
									}
								?>
								</td>
							...
							<tr>
								<td>
									<?php echo JText::_('
											Use <a href="http://extensions.joomla.org/component/option,com_mtree/task,viewlink/link_id,3955/Itemid,35/" target="_blank">AVReloaded Viewer</a>
											(1.2.4 of higher Must be installed): ').$this->lists['internal_viewer']; ?>
								</td>
							</tr>
							<tr>
								<td>
									<input 
										...
										size="100%"
										maxlength="500" 
										onChange="AvReloadedInsert(this.mtag);"
										onKeyUp="AvReloadedInsert(this.mtag);"
										onKeyPress="AvReloadedInsert(this.mtag);"
										value="<?php echo $this->mediafilesedit->mediacode;?>" />
									<?php if (JPluginHelper::importPlugin('system', 'avreloaded')){
										echo $this->mbutton;
									}?>
								</td>
							</tr>
							...
							<tr>
								...
								<input 
									...
									size="20" 
									maxlength="20" 
									onChange="decOnly(this);" 
									onKeyUp="decOnly(this);" 
							...
							<tr>
								<td>
									...
									<input 
										...
										size="75" 
										maxlength="75"
										value="<?php echo $this->mediafilesedit->filename;?>" />
								</td>
							</tr>
							<tr>
								<td>
									<?php echo JText::_( 'Or Upload File: ' ); ?>
									<input type="file" id="file" name="file" size="75" />
								</td>
							</tr>
							<tr>
							...
							<tr>
								<td>
									<?php echo JText::_('Use file name as entire path if you wish. Just don\'t select a server or path. (Don\'t use this option if uploading)');?><br />
									<?php echo JText::_('- Target for link (ie: _self, _blank): ')?>
									<input
										class="text_area" 
										type="text" 
										name="special" 
										...
										size="15"
										maxlength="15" 
										value="<?php echo $this->mediafilesedit->special;?>" />
								</td>
							</tr>
							<tr>
							...
							<tr>
								<td><?php echo JText::_('Choose a Mime Type: ');?> <?php echo $this->lists['mime_type'];?></td>
							</tr>
							<tr>
