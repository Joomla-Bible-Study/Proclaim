...
<tbody><tr>
  <div id="biblestudy<?php echo $pageclass_sfx;?>" class="noRefTagger<?php echo $pageclass_sfx;?>"> <!-- This div is the container for the whole page -->
...
if ( $this->params->get( 'show_page_title' ) >0 ) {
    ...
    <div id="bsdropdownmenu<?php echo $pageclass_sfx;?>">
  ...
  if (!$filter_book ) {
   ...
   if (!$filter_orders ) {
    ...
    <table id="bslisttable<?php echo $pageclass_sfx;?>" cellspacing="0">
      <thead>
        <tr>
        ...
        <tr class="lastrow<?php echo $pageclass_sfx;?>">
          <th id="bsdeschead" class="row3col1 lastcol" colspan="4">Description</th>
        </tr>
      </thead>
      <tbody>

        <tr class="bsodd<?php echo $pageclass_sfx;?>">
          ...
          <td class="row1col4 lastcol" rowspan="2" headers="bsmediahead">
            <table class="mediatable<?php echo $pageclass_sfx;?>"><tbody>
              <tr>
                <td>
        ...
        <tr class="bseven">
          <td class="row2col1 bsscripture<?php echo $pageclass_sfx;?>" headers="bsscripthead">Luke 5:17-26</td>
          <td class="row2col2 bsteacher<?php echo $pageclass_sfx;?>" headers="bsteacherhead">Dan Ellrick</td>
          <td class="row2col3 bsduration<?php echo $pageclass_sfx;?>" headers="bsdyrhead">46:02</td>
        <tr class="bseven lastrow<?php echo $pageclass_sfx;?>">
          <td class="row3col1 bsdesc lastcol<?php echo $pageclass_sfx;?>" colspan="4" headers="bsdeschead">
