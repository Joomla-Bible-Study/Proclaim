...
Text::script('JBS_IBM_SUMMARY_RESTORED');
Text::script('JBS_IBM_SUMMARY_TABLES');
Text::script('JBS_IBM_SUMMARY_TASKS');
Text::script('JBS_IBM_SUMMARY_TEMPLATECODES');
Text::script('JBS_IBM_SUMMARY_AUTO_INCREMENT');
Text::script('JBS_IBM_SUMMARY_CONFIG');
Text::script('JBS_IBM_SUMMARY_ATTENTION');
Text::script('JBS_IBM_SUMMARY_NOTHING_OUTSTANDING');
Text::script('JBS_IBM_MEDIA_DIR_MISSING');
Text::script('JBS_IBM_MEDIA_DIR_EMPTY');
