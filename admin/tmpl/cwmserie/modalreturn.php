...
/**
 * Series modal return — sends PostMessage back to parent with selected series data
 *
...
$icon    = 'icon-check';
$title   = $this->item ? $this->item->series_text : '';
$content = $this->item ? $this->item->alias : '';
$data    = ['contentType' => 'com_proclaim.serie'];

if ($this->item) {
    $data['id']    = $this->item->id;
    $data['title'] = $this->item->series_text;
}
