...
<div class="container-popup">
    <form action="<?php
    echo Route::_(
        'index.php?option=com_proclaim&view=cwmmessages&layout=modal&tmpl=component&function=' .
            ...
            <table class="table table-sm">
                ...
                <tr>
                    <th scope="col" class="w-1 text-center">
                        <?php
                        echo HTMLHelper::_('searchtools.sort', 'JSTATUS', 'study.published', $listDirn, $listOrder); ?>
                    </th>
