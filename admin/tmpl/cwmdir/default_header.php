...
<div id="fm_breadcrumbs">
    ...
    <div id="folder_input_form">
        <form id="input_form" action="" method="post">
            <label for="folder_name"><?php
                echo Text::_('COM_MEDIAMU_DIR_BROSWER_LB_FOLDER_NAME'); ?></label>
    ...
    <table id="files">
        ...
        <tr>
            ...
            <th scope="row" class="file_name">
                <?php
                echo Text::_('COM_MEDIAMU_DIR_BROSWER_FILE_NAME'); ?>
            </th>
            <th scope="row" class="size">
                <?php
                echo Text::_('COM_MEDIAMU_DIR_BROSWER_SIZE'); ?>
            </th>
