...
/**
 * Message modal return — sends PostMessage back to parent with selected message data
 *
...
$icon    = 'icon-check';
$title   = $this->item ? $this->item->studytitle : '';
$content = $this->item ? ($this->item->alias ?? '') : '';
$data    = ['contentType' => 'com_proclaim.message'];

if ($this->item) {
    $data['id']    = $this->item->id;
    $data['title'] = $this->item->studytitle;
}
