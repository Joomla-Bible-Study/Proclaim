...
<script type="text/javascript">
	...
	jQuery.submitbutton7 = function () {
		...
		jQuery('[name=task]').val('admin.convertPreachIt')
		jQuery('#item-admin').submit()
	}
	...
	<div class="row-fluid">
		...
		<div class="span12">
			<ul class="nav nav-tabs" id="configTabs">
				<li class="active"><a href="#cpanl" data-toggle="tab"><?php echo JText::_('JBS_ADM_ADMIN_CPANL'); ?></a>
				</li>
			...
			<div class="tab-content">
				...
				<div class="tab-pane" id="convert">
					...
					<a href="<?php echo JRoute::_('index.php?option=com_biblestudy&view=assets&task=admin.convertPreachIt&' .
						JSession::getFormToken() . '=1'); ?>"
