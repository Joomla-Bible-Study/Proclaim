...
<form
	...
	<div class="row-fluid">
		<!-- Begin Sidebar -->
		<?php echo HTMLHelper::_('uitab.startTabSet', 'myTab', array('active' => 'cpanl')); ?>

		<!--			<ul class="nav nav-tabs" id="configTabs">-->
		<!--				<li class="active"><a href="#cpanl" data-toggle="tab">-->
		<?php //echo JText::_('JBS_ADM_ADMIN_CPANL'); ?><!--</a>-->
		<!--				</li>-->
		<!--				<li><a href="#admin" data-toggle="tab">-->
		<?php //echo JText::_('JBS_ADM_ADMIN_PARAMS'); ?><!--</a></li>-->
		<!--				<li><a href="#defaults" data-toggle="tab">-->
		<?php //echo JText::_('JBS_ADM_SYSTEM_DEFAULTS'); ?><!--</a></li>-->
		<!--				<li><a href="#playersettings" data-toggle="tab">-->
		<?php //echo JText::_('JBS_ADM_PLAYER_SETTINGS'); ?><!--</a>-->
		<!--				</li>-->
		<!--				<li><a href="#jwplayer" data-toggle="tab">-->
		<?php //echo JText::_('JBS_ADM_JWPLAYER'); ?><!--</a></li>-->
		<!--				<li><a href="#convert" data-toggle="tab">-->
		<?php //echo JText::_('JBS_IBM_CONVERT'); ?><!--</a></li>-->
		<!--				<li><a href="#images" data-toggle="tab">-->
		<?php //echo JText::_('JBS_IBM_IMAGES'); ?><!--</a></li>-->
		<!--			</ul>-->
		...
		<?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'admin', Text::_('JBS_ADM_ADMIN_PARAMS')); ?>
