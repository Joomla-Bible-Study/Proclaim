...
class CwmImageMigration
{
    ...
    public static function isCoreImage(string $path): bool
    {
        ...
        // Direct path to the core images directory
    ...
    public static function migrateRecord(
        ...
        // If a source file is still missing, report it but do NOT clear the DB field.
        ...
        // Create a new thumbnail using Cwmthumbnail
        try {
    ...
    private static function findExistingMigratedFiles(string $type, int $id, string $title, string $alias): ?array
    {
        ...
        // Also check the bare-ID folder (legacy migration artefact: folder named just "528" instead of "alias-528")
    ...
    public static function getUnresolvableRecords(): array
    {
        ...
        foreach (['studies', 'teachers', 'series'] as $type) {
            ...
            foreach ($records as $row) {
                ...
                // Check if the original or thumbnail exists
                $found = false;
     ...
     * @param   string  $imageCol  Column name for an original image path
     * @param   string  $thumbCol  Column name for a thumbnail path
     *
