...
final class Version
{
     ...
     * @since  3.8.0
     */
    public const string EXTRA_VERSION = 'beta1';
     ...
     * @since  3.5
     */
    public const string DEV_STATUS = 'Beta';
     ...
     * @since  3.5
     */
    public const string RELDATE = '2-March-2026';
     ...
     * @since  3.5
     */
    public const string RELTIME = '22:23';
    ...
    private function getMediaVersionCache(): CacheController
    {
        ...
        $cache = \Joomla\CMS\Factory::getContainer()->get(CacheControllerFactoryInterface::class)
