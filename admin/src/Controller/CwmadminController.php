...
class CwmadminController extends FormController
{
    ...
    // Scripture AJAX methods (getScriptureStatusXHR, getTranslationsXHR,
    // downloadTranslationXHR, removeTranslationXHR, removeAllTranslationsXHR,
    // updateAllTranslationsXHR, syncApiBibleTranslationsXHR, cleanupProviderXHR)
    // moved to plg_content_scripturelinks onAjaxScripturelinks handler in 10.3.0.
    ...
    public function detectUpgradeXHR(): void
    {
        ...
        try {
            ...
            $this->sendJsonPayload($detection);
        } catch (\Throwable $e) {
            $this->sendJsonPayload([
                'detected' => false,
                'error'    => $e->getMessage(),
    ...
    public function upgradeSchemaXHR(): void
    {
        ...
        try {
            ...
            $this->sendJsonPayload($migrationResult);
        } catch (\Throwable $e) {
            $this->sendJsonPayload([
                'success' => false,
                'message' => $e->getMessage(),
    ...
    public function upgradeVerifyXHR(): void
    {
        ...
        try {
            ...
            $this->sendJsonPayload($verifyResult);
        } catch (\Throwable $e) {
            $this->sendJsonPayload([
                'success' => false,
                'message' => $e->getMessage(),
