...
use CWM\Component\BibleStudy\Administrator\Lib\CWMBackup;
use CWM\Component\BibleStudy\Administrator\Model\AdminModel;
 ...
 * @since  7.0.0
 */
class AdministrationController extends FormController
{
	/**
