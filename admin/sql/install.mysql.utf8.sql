...
VALUES (1, 'JBS_BBK_GENESIS', 101, 1),
...
INSERT IGNORE INTO `#__bsms_mediafiles` (`id`, `study_id`, `server_id`, `podcast_id`, `metadata`, `ordering`,
                                         `createdate`, `hits`, `published`, `comment`, `downloads`, `plays`, `params`,
                                         `asset_id`, `access`, `language`, `created_by`, `created_by_alias`, `modified`,
                                         `modified_by`, `checked_out`, `checked_out_time`)
VALUES (1, 1, 1, '1', '{\"plays\":\"0\", \"downloads\":\"0\"}', 0, '2009-09-13 00:10:00', 0, 1, 'Sample Media file', 0,
        10,
...
INSERT IGNORE INTO `#__bsms_message_type` (`id`, `message_type`, `alias`, `published`, `asset_id`, `access`, `ordering`,
                                           `landing_show`)
VALUES (1, 'Sunday', X'73756E646179', 1, 7482, 1, 1, NULL);

-- Dump of table #__bsms_podcast
-- ------------------------------------------------------------

INSERT IGNORE INTO `#__bsms_podcast` (`id`, `title`, `website`, `podcastlink`, `description`, `subtitle`, `image`,
                                      `imageh`, `imagew`, `author`, `podcastimage`, `podcastsearch`, `filename`,
                                      `language`, `editor_name`, `editor_email`, `podcastlimit`, `published`,
                                      `episodetitle`, `custom`, `detailstemplateid`, `asset_id`, `access`,
                                      `alternatelink`, `alternateimage`, `podcast_subscribe_show`,
                                      `podcast_image_subscribe`, `podcast_subscribe_desc`, `alternatewords`,
                                      `episodesubtitle`, `customsubtitle`, `linktype`)
VALUES (1, 'My Podcast', 'www.mywebsite.com', 'www.mywebsite.com/PodcastController.php',
        'Podcast Description goes here', 'Short sentence about the podcast', 'www.mywebsite.com/myimage.jpg', 30, 30,
        'Pastor Billy', 'www.mywebsite.com/myimage.jpg', 'jesus', 'mypodcast.xml', '*', 'Jim Editor',
        'jim@mywebsite.com',
...
INSERT IGNORE INTO `#__bsms_series` (`id`, `series_text`, `alias`, `teacher`, `description`, `series_thumbnail`,
                                     `published`, `asset_id`, `ordering`, `access`, `language`, `landing_show`,
                                     `pc_show`)
VALUES (1, 'Worship Series', X'776F72736869702D736572696573', -1, '', '', 1, 7484, 1, 1, '*', NULL, 1);
...
INSERT IGNORE INTO `#__bsms_studies` (`id`, `studydate`, `teacher_id`, `studynumber`, `booknumber`, `chapter_begin`,
                                      ...
                                      `chapter_begin2`, `verse_begin2`, `chapter_end2`, `verse_end2`, `prod_dvd`,
                                      `prod_cd`, `server_cd`, `server_dvd`, `image_cd`, `image_dvd`, `studytext2`,
...
VALUES (1, '2010-03-13 00:10:00', 1, '2015-01', 151, 3, 5, 3, 11, '', '-1', '', '', '', '', NULL, NULL, NULL, NULL,
        NULL,
        ...
        0, '0000-00-00 00:00:00', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '2015-07-28 23:46:05', 627, 7479, 1,
        1,
        '*', -1);
